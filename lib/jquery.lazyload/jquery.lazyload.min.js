!(function (t, e, o, i) {
  ...
  (t.fn.lazyload = function (i) {
      ...
      f.each(function () {
        ...
        if (!l.skip_invisible || o.is(":visible"))
          if (t.abovethetop(this, l) || t.leftofbegin(this, l));
            ...
            t.belowthefold(this, l) ||
            (!o.closest(".owl-carousel").length && t.rightoffold(this, l))
          ) {
    ...
    return (
      i &&
        (void 0 !== i.failurelimit &&
          ((i.failure_limit = i.failurelimit), delete i.failurelimit),
        void 0 !== i.effectspeed &&
          ((i.effect_speed = i.effectspeed), delete i.effectspeed),
        t.extend(l, i)),
      (a = void 0 === l.container || l.container === e ? n : t(l.container)),
      ...
      this.each(function () {
        ...
        (e.loaded = !1),
          (void 0 !== o.attr("src") && !1 !== o.attr("src")) ||
            (o.is("img") && o.attr("src", l.placeholder)),
          o.one("appear", function (i) {
            if (!this.loaded) {
              if (l.appear) {
                var n = f.length;
                l.appear.call(e, n, l);
              }
              var r = o.attr("data-oi")
                ? "data-oi"
                : "data-" + l.data_attribute;
              t("<img />")
                .bind("load", function () {
                  var i = o.attr(r),
                    n = o.attr("data-" + l.data_srcset);
                  o.is("img")
                    ? (o.hide().addClass("no-transition"),
                      o.attr("src", i),
                      n && o.attr("srcset", n),
                      o[l.effect](l.effect_speed, function () {
          ...
          o.is(":hidden") && !e.loaded && o.trigger("appear");
      }),
    ...
    (t.belowthefold = function (o, i) {
      return (
        (void 0 === i.container || i.container === e
          ? (e.innerHeight ? e.innerHeight : n.height()) + n.scrollTop()
