<?php
	...
	$query = "SELECT c.cust_name , p.prod_name , r.rating , r.review , r.review_date FROM `tbl_review` r , `tbl_order` o , `tbl_product` p , `tbl_customer` c WHERE r.id = o.id AND o.prod_id = p.prod_id AND o.cust_id = c.cust_id AND p.shop_id = $shop_id ORDER BY r.review_date DESC LIMIT 5";
