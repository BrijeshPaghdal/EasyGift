<?php
    ...
    $shop_id = $_SESSION['Shop_Id'];
		...
		$query = "SELECT o.order_id , o.cust_id , p.prod_id , p.prod_name ,c.cate_name , p.comp_name , o.first_name , o.last_name , o.phone_no , o.quantity , o.total_price , o.order_date,  o.status FROM `tbl_product` p , `tbl_sub_category` s , `tbl_category` c , `tbl_order` o ";
		$query .= " WHERE s.sub_c_id = p.sub_c_id AND o.prod_id = p.prod_id AND c.cate_id = s.cate_id AND status = $status AND p.shop_id = $shop_id ORDER by o.order_date DESC ";
