"use strict";
! function(l, e) {
    "object" == typeof exports ? module.exports = e() : "function" == typeof define && define.amd ? define(["jquery", "googlemaps!"], e) : l.GMaps = e()
}(this, function() {
    function T(l, e) {
        var t;
        if (l === e) return l;
    ...
    function o(l, t) {
        var e, a = Array.prototype.slice.call(arguments, 2),
            s = [],
            o = l.length;
        if (Array.prototype.map && l.map === Array.prototype.map) s = Array.prototype.map.call(l, function(l) {
            var e = a.slice(0);
            return e.splice(0, 0, l), t.apply(this, e)
        });
        else
            for (e = 0; e < o; e++) callback_params = a, callback_params.splice(0, 0, l[e]), s.push(t.apply(this, callback_params));
        return s
    }
    ...
    function j(l, e) {
        return l = l.replace("#", ""), "jQuery" in window && e ? $("#" + l, e)[0] : document.getElementById(l)
    }
    var P, _, t, i, r = function(l, e) {
            var t, a, s, o, n;
            for (t = 0; t < l.length; t++) l[t] instanceof google.maps.LatLng || (0 < l[t].length && "object" == typeof l[t][0] ? l[t] = r(l[t], e) : l[t] = (a = l[t], s = e, n = o = void 0, o = a[0], n = a[1], s && (o = a[1], n = a[0]), new google.maps.LatLng(o, n)));
            return l
        },
        c = (P = document, _ = function(t) {
            ...
            if ("string" == typeof t.el || "string" == typeof t.div ? -1 < n.indexOf("#") ? this.el = j(n, t.context) : this.el = function(l, e) {
                    var t = l.replace(".", "");
                    return "jQuery" in this && e ? $("." + t, e)[0] : document.getElementsByClassName(t)[0]
                }.apply(this, [n, t.context]) : this.el = n, void 0 === this.el || null === this.el) throw "No element defined.";
            for (window.context_menu = window.context_menu || {}, window.context_menu[u.el.id] = {}, this.controls = [], this.overlays = [], this.layers = [], this.singleLayers = {}, this.markers = [], this.polylines = [], this.routes = [], this.polygons = [], this.infoWindow = null, this.overlay_el = null, this.zoom = t.zoom, this.registered_events = {}, this.el.style.width = t.width || this.el.scrollWidth || this.el.offsetWidth, this.el.style.height = t.height || this.el.scrollHeight || this.el.offsetHeight, google.maps.visualRefresh = t.enableNewStyle, e = 0; e < o.length; e++) delete t[o[e]];
            for (1 != t.disableDefaultUI && (M = T(M, b)), y = T(M, t), e = 0; e < a.length; e++) delete y[a[e]];
            for (e = 0; e < s.length; e++) delete y[s[e]];
            this.map = new google.maps.Map(this.el, y), i && (this.markerClusterer = i.apply(this, [this.map]));
            ...
            function w(e, t) {
                ...
                for (var s in a)
                    if (a.hasOwnProperty(s)) {
                        var o = a[s];
                        l += '<li><a id="' + e + "_" + s + '" href="#">' + o.title + "</a></li>"
                    }
                if (j("gmaps_context_menu")) {
                    ...
                    for (s = 0; s < r; s++) {
                        var c = i[s];
                        google.maps.event.clearListeners(c, "click"), google.maps.event.addDomListenerOnce(c, "click", function(l) {
                            l.preventDefault(), a[this.id.replace(e + "_", "")].action.apply(u, [t]), u.hideContextMenu()
                        }, !1)
                    }
                    var h = function(l) {
                            var e = 0,
                            ...
                            if (l.offsetParent)
                                for (; e += l.offsetLeft, t += l.offsetTop, l = l.offsetParent;);
                            return [e, t]
                        }.apply(this, [u.el]),
                        p = h[0] + t.pixel.x - 15,
                        m = h[1] + t.pixel.y - 15;
            ...
            this.buildContextMenu = function(t, a) {
                if ("marker" === t) {
                    ...
                    s.setMap(u.map), s.draw = function() {
                ...
                t.id = "gmaps_context_menu", t.style.display = "none", t.style.position = "absolute", t.style.minWidth = "100px", t.style.background = "white", t.style.listStyle = "none", t.style.padding = "8px", t.style.boxShadow = "2px 2px 6px #ccc", j("gmaps_context_menu") || P.body.appendChild(t);
                var s = j("gmaps_context_menu");
                google.maps.event.addDomListener(s, "mouseout", function(l) {
                    l.relatedTarget && this.contains(l.relatedTarget) || window.setTimeout(function() {
            ...
            google.maps.event.addListener(this.map, "rightclick", function(l) {
                t.rightclick && t.rightclick.apply(this, [l]), null != window.context_menu[u.el.id].map && u.buildContextMenu("map", l)
            }), this.refresh = function() {
                google.maps.event.trigger(this.map, "resize")
            }, this.fitZoom = function() {
                var l, e = [],
                    t = this.markers.length;
                for (l = 0; l < t; l++) "boolean" == typeof this.markers[l].visible && this.markers[l].visible && e.push(this.markers[l].getPosition());
                ...
                l = l || 1, this.zoom = this.map.getZoom() + l, this.map.setZoom(this.zoom)
            }, this.zoomOut = function(l) {
                l = l || 1, this.zoom = this.map.getZoom() - l, this.map.setZoom(this.zoom)
            };
            var O, x = [];
            for (O in this.map) "function" != typeof this.map[O] || this[O] || x.push(O);
            for (e = 0; e < x.length; e++) ! function(l, e, t) {
                l[t] = function() {
    ...
    return c.prototype.createControl = function(t) {
        ...
        for (var e in l.style.cursor = "pointer", !0 !== t.disableDefaultStyles && (l.style.fontFamily = "Roboto, Arial, sans-serif", l.style.fontSize = "11px", l.style.boxShadow = "rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px"), t.style) l.style[e] = t.style[e];
        for (var a in t.id && (l.id = t.id), t.title && (l.title = t.title), t.classes && (l.className = t.classes), t.content && ("string" == typeof t.content ? l.innerHTML = t.content : t.content instanceof HTMLElement && l.appendChild(t.content)), t.position && (l.position = google.maps.ControlPosition[t.position.toUpperCase()]), t.events) ! function(l, e) {
        ...
        var e, t = null;
        for (e = 0; e < this.controls.length; e++) this.controls[e] == l && (t = this.controls[e].position, this.controls.splice(e, 1));
        if (t)
        ...
        if (null == a.lat && null == a.lng && null == a.position) throw "No latitude or longitude defined.";
        var e = this,
            l = a.details,
            t = a.fences,
            s = a.outside,
        ...
        if (i.fences = t, a.infoWindow) {
            ...
            for (var r = ["closeclick", "content_changed", "domready", "position_changed", "zindex_changed"], c = 0; c < r.length; c++) ! function(l, e) {
                a.infoWindow[e] && google.maps.event.addListener(l, e, function(l) {
                    a.infoWindow[e].apply(this, [l])
                })
            }(i.infoWindow, r[c])
        }
        var h = ["animation_changed", "clickable_changed", "cursor_changed", "draggable_changed", "flat_changed", "icon_changed", "position_changed", "shadow_changed", "shape_changed", "title_changed", "visible_changed", "zindex_changed"],
            p = ["dblclick", "drag", "dragend", "dragstart", "mousedown", "mouseout", "mouseover", "mouseup"];
        for (c = 0; c < h.length; c++) ! function(l, e) {
            a[e] && google.maps.event.addListener(l, e, function() {
                a[e].apply(this, [this])
            })
        }(i, h[c]);
        for (c = 0; c < p.length; c++) ! function(e, l, t) {
            a[t] && google.maps.event.addListener(l, t, function(l) {
                l.pixel || (l.pixel = e.getProjection().fromLatLngToPoint(l.latLng)), a[t].apply(this, [l])
            })
        }(this.map, i, p[c]);
        return google.maps.event.addListener(i, "click", function() {
            this.details = l, a.click && a.click.apply(this, [this]), i.infoWindow && (e.hideInfoWindows(), i.infoWindow.open(e.map, i))
        }), google.maps.event.addListener(i, "rightclick", function(l) {
            l.marker = this, a.rightclick && a.rightclick.apply(this, [l]), null != window.context_menu[e.el.id].marker && e.buildContextMenu("marker", l)
        ...
        if (l.hasOwnProperty("gm_accessors_")) e = l;
            ...
            if (!(l.hasOwnProperty("lat") && l.hasOwnProperty("lng") || l.position)) throw "No latitude or longitude defined.";
        ...
        for (var l, e = 0; l = this.markers[e]; e++) l.infoWindow && l.infoWindow.close()
    }, c.prototype.removeMarker = function(l) {
        for (var e = 0; e < this.markers.length; e++)
            if (this.markers[e] === l) {
                this.markers[e].setMap(null), this.markers.splice(e, 1), this.markerClusterer && this.markerClusterer.removeMarker(l), c.fire("marker_removed", l, this);
                break
            }
        return l
        ...
        if (void 0 === l) {
            ...
            for (t = 0; t < l.length; t++) {
                ...
                if (-1 < a)(s = this.markers[a]).setMap(null), this.markerClusterer && this.markerClusterer.removeMarker(s), c.fire("marker_removed", s, this)
            }
        ...
        var i = new google.maps.OverlayView,
            o = !0;
        return i.setMap(this.map), null != n.auto_show && (o = n.auto_show), i.onAdd = function() {
            var l = document.createElement("div");
            l.style.borderStyle = "none", l.style.borderWidth = "0px", l.style.position = "absolute", l.style.zIndex = 100, l.innerHTML = n.content, i.el = l, n.layer || (n.layer = "overlayLayer");
            var e, t, a = this.getPanes(),
                s = ["contextmenu", "DOMMouseScroll", "dblclick", "mousedown"];
            a[n.layer].appendChild(l);
            for (var o = 0; o < s.length; o++) e = l, t = s[o], google.maps.event.addDomListener(e, t, function(l) {
                -1 != navigator.userAgent.toLowerCase().indexOf("msie") && document.all ? (l.cancelBubble = !0, l.returnValue = !1) : l.stopPropagation()
            });
            n.click && (a.overlayMouseTarget.appendChild(i.el), google.maps.event.addDomListener(i.el, "click", function() {
                n.click.apply(i, [i])
            })), google.maps.event.trigger(this, "ready")
        }, i.draw = function() {
            var l = this.getProjection().fromLatLngToDivPixel(new google.maps.LatLng(n.lat, n.lng));
            ...
            e.style.display = o ? "block" : "none", o || n.show.apply(this, [e])
        }, i.onRemove = function() {
            var l = i.el;
            n.remove ? n.remove.apply(this, [l]) : (i.el.parentNode.removeChild(i.el), i.el = null)
        }, this.overlays.push(i), i
        ...
        if (e.length)
            if (void 0 === e[0][0]) l = e;
                ...
                for (var a, s = 0; a = e[s]; s++) l.push(new google.maps.LatLng(a[0], a[1]));
        var o = {
            map: this.map,
            path: l,
        ...
        for (var n = new google.maps.Polyline(o), i = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], r = 0; r < i.length; r++) ! function(l, e) {
            t[e] && google.maps.event.addListener(l, e, function(l) {
                t[e].apply(this, [l])
            })
        }(n, i[r]);
        ...
        for (var e = 0; e < this.polylines.length; e++)
            if (this.polylines[e] === l) {
                this.polylines[e].setMap(null), this.polylines.splice(e, 1), c.fire("polyline_removed", l, this);
                break
            }
        ...
        for (var l = new google.maps.Circle(t), e = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], a = 0; a < e.length; a++) ! function(l, e) {
            t[e] && google.maps.event.addListener(l, e, function(l) {
                t[e].apply(this, [l])
            })
        }(l, e[a]);
        ...
        var l = new google.maps.LatLngBounds(new google.maps.LatLng(t.bounds[0][0], t.bounds[0][1]), new google.maps.LatLng(t.bounds[1][0], t.bounds[1][1]));
        t.bounds = l;
        for (var e = new google.maps.Rectangle(t), a = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], s = 0; s < a.length; s++) ! function(l, e) {
            t[e] && google.maps.event.addListener(l, e, function(l) {
                t[e].apply(this, [l])
            })
        }(e, a[s]);
        ...
        var l = !1;
        t.hasOwnProperty("useGeoJSON") && (l = t.useGeoJSON), delete t.useGeoJSON, t = T({
            map: this.map
        }, t), 0 == l && (t.paths = [t.paths.slice(0)]), 0 < t.paths.length && 0 < t.paths[0].length && (t.paths = n(o(t.paths, r, l)));
        for (var e = new google.maps.Polygon(t), a = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], s = 0; s < a.length; s++) ! function(l, e) {
            t[e] && google.maps.event.addListener(l, e, function(l) {
                t[e].apply(this, [l])
            })
        }(e, a[s]);
        ...
        for (var e = 0; e < this.polygons.length; e++)
            if (this.polygons[e] === l) {
                this.polygons[e].setMap(null), this.polygons.splice(e, 1), c.fire("polygon_removed", l, this);
                break
            }
        ...
        switch (e = e || {}, l) {
            ...
            case "bicycling":
                ...
                break;
            case "panoramio":
                this.singleLayers.panoramio = t = new google.maps.panoramio.PanoramioLayer, t.setTag(e.filter), delete e.filter, e.click && google.maps.event.addListener(t, "click", function(l) {
                    e.click(l), delete e.click
                });
                break;
            case "places":
                if (this.singleLayers.places = t = new google.maps.places.PlacesService(this.map), e.search || e.nearbySearch || e.radarSearch) {
                    var a = {
                    ...
                    e.radarSearch && t.radarSearch(a, e.radarSearch), e.search && t.search(a, e.search), e.nearbySearch && t.nearbySearch(a, e.nearbySearch)
                }
                if (e.textSearch) {
                    var s = {
                        bounds: e.bounds || null,
        ...
        if (void 0 !== t) return "function" == typeof t.setOptions && t.setOptions(e), "function" == typeof t.setMap && t.setMap(this.map), t
    }, c.prototype.removeLayer = function(l) {
        if ("string" == typeof l && void 0 !== this.singleLayers[l]) this.singleLayers[l].setMap(null), delete this.singleLayers[l];
        else
        ...
        i = "imperial" === a.unitSystem ? google.maps.UnitSystem.IMPERIAL : google.maps.UnitSystem.METRIC;
        var l = T({
            avoidHighways: !1,
            avoidTolls: !1,
            optimizeWaypoints: !1,
        ...
        l.origin = /string/.test(typeof a.origin) ? a.origin : new google.maps.LatLng(a.origin[0], a.origin[1]), l.destination = /string/.test(typeof a.destination) ? a.destination : new google.maps.LatLng(a.destination[0], a.destination[1]), l.travelMode = t, l.unitSystem = i, delete l.callback, delete l.error;
        var s = [];
        (new google.maps.DirectionsService).route(l, function(l, e) {
            if (e === google.maps.DirectionsStatus.OK) {
                for (var t in l.routes) l.routes.hasOwnProperty(t) && s.push(l.routes[t]);
        ...
        0 < (l = T({
            ...
            path: !1,
            samples: 256
        }, l)).locations.length && 0 < l.locations[0].length && (l.locations = n(o([l.locations], r, !1)));
        var t = l.callback;
        delete l.callback;
        ...
        } else delete l.path, delete l.samples, e.getElevationForLocations(l, function(l, e) {
            t && "function" == typeof t && t(l, e)
        })
    }, c.prototype.cleanRoute = c.prototype.removePolylines, c.prototype.renderRoute = function(l, e) {
        var a, t = "string" == typeof e.panel ? document.getElementById(e.panel.replace("#", "")) : e.panel;
        e.panel = t, e = T({
            map: this.map
        }, e), a = new google.maps.DirectionsRenderer(e), this.getRoutes({
            origin: l.origin,
        ...
        this.getRoutes({
            ...
            callback: function(l) {
                if (0 < l.length) {
                    ...
                    t.hasOwnProperty("icons") && (e.icons = t.icons), a.drawPolyline(e), t.callback && t.callback(l[l.length - 1])
                }
            }
        })
    }, c.prototype.travelRoute = function(o) {
        if (o.origin && o.destination) this.getRoutes({
            origin: o.origin,
            ...
            error: o.error,
            callback: function(l) {
                if (0 < l.length && o.start && o.start(l[l.length - 1]), 0 < l.length && o.step) {
                    var e = l[l.length - 1];
                    if (0 < e.legs.length)
                        for (var t, a = e.legs[0].steps, s = 0; t = a[s]; s++) t.step_number = s, o.step(t, e.legs[0].steps.length - 1)
                }
                0 < l.length && o.end && o.end(l[l.length - 1])
            }
        });
        else if (o.route && 0 < o.route.legs.length)
            for (var l, e = o.route.legs[0].steps, t = 0; l = e[t]; t++) l.step_number = t, o.step(l)
    }, c.prototype.drawSteppedRoute = function(n) {
        var i = this;
        if (n.origin && n.destination) this.getRoutes({
            origin: n.origin,
            ...
            error: n.error,
            callback: function(l) {
                if (0 < l.length && n.start && n.start(l[l.length - 1]), 0 < l.length && n.step) {
                    var e = l[l.length - 1];
                    if (0 < e.legs.length)
                        for (var t, a = e.legs[0].steps, s = 0; t = a[s]; s++) {
                            ...
                            n.hasOwnProperty("icons") && (o.icons = n.icons), i.drawPolyline(o), n.step(t, e.legs[0].steps.length - 1)
                        }
                }
            ...
            for (var l, e = n.route.legs[0].steps, t = 0; l = e[t]; t++) {
                ...
                n.hasOwnProperty("icons") && (a.icons = n.icons), i.drawPolyline(a), n.step(l)
            }
    }, c.Route = function(l) {
        this.origin = l.origin, this.destination = l.destination, this.waypoints = l.waypoints, this.map = l.map, this.route = l.route, this.step_count = 0, this.steps = this.route.legs[0].steps, this.steps_length = this.steps.length;
        var e = {
        ...
        l.hasOwnProperty("icons") && (e.icons = l.icons), this.polyline = this.map.drawPolyline(e).getPath()
        ...
        l = l || {};
        var e = {};
        if (e.size = l.size || [this.el.clientWidth, this.el.clientHeight], e.lat = this.getCenter().lat(), e.lng = this.getCenter().lng(), 0 < this.markers.length) {
            e.markers = [];
            for (var t = 0; t < this.markers.length; t++) e.markers.push({
        ...
        if (0 < this.polylines.length) {
            ...
            e.polyline = {}, e.polyline.path = google.maps.geometry.encoding.encodePath(a.getPath()), e.polyline.strokeColor = a.strokeColor, e.polyline.strokeOpacity = a.strokeOpacity, e.polyline.strokeWeight = a.strokeWeight
        }
        return c.staticMapURL(e)
    }, c.staticMapURL = function(l) {
        var e, t = [],
            a = ("file:" === location.protocol ? "http:" : location.protocol) + "//maps.googleapis.com/maps/api/staticmap";
        ...
        delete l.styles;
        var n = l.polyline;
        if (delete l.polyline, l.center) t.push("center=" + l.center), delete l.center;
        else if (l.address) t.push("center=" + l.address), delete l.address;
        else if (l.lat) t.push(["center=", l.lat, ",", l.lng].join("")), delete l.lat, delete l.lng;
        else if (l.visible) {
            var i = encodeURI(l.visible.join("|"));
            t.push("visible=" + i)
        }
        var r = l.size;
        r ? (r.join && (r = r.join("x")), delete l.size) : r = "630x300", t.push("size=" + r), l.zoom || !1 === l.zoom || (l.zoom = 15);
        var c = !l.hasOwnProperty("sensor") || !!l.sensor;
        for (var h in delete l.sensor, t.push("sensor=" + c), l) l.hasOwnProperty(h) && t.push(h + "=" + l[h]);
        if (s)
            for (var p, m, u = 0; e = s[u]; u++) {
                for (var h in p = [], e.size && "normal" !== e.size ? (p.push("size:" + e.size), delete e.size) : e.icon && (p.push("icon:" + encodeURI(e.icon)), delete e.icon), e.color && (p.push("color:" + e.color.replace("#", "0x")), delete e.color), e.label && (p.push("label:" + e.label[0].toUpperCase()), delete e.label), m = e.address ? e.address : e.lat + "," + e.lng, delete e.address, delete e.lat, delete e.lng, e) e.hasOwnProperty(h) && p.push(h + ":" + e[h]);
                p.length || 0 === u ? (p.push(m), p = p.join("|"), t.push("markers=" + encodeURI(p))) : (p = t.pop() + encodeURI("|" + m), t.push(p))
            }
        if (o)
            for (u = 0; u < o.length; u++) {
                var g = [];
                o[u].featureType && g.push("feature:" + o[u].featureType.toLowerCase()), o[u].elementType && g.push("element:" + o[u].elementType.toLowerCase());
                for (var L = 0; L < o[u].stylers.length; L++)
                    for (var d in o[u].stylers[L]) {
                        var v = o[u].stylers[L][d];
                        "hue" != d && "color" != d || (v = "0x" + v.substring(1)), g.push(d + ":" + v)
                    }
                var z = g.join("|");
                "" != z && t.push("style=" + z)
            }
        ...
        function f(l, e) {
            if ("#" === l[0] && (l = l.replace("#", "0x"), e)) {
                ...
                1 === (e = (255 * e).toString(16)).length && (e += e), l = l.slice(0, 8) + e
            }
            return l
        }
        if (n) {
            if (e = n, n = [], e.strokeWeight && n.push("weight:" + parseInt(e.strokeWeight, 10)), e.strokeColor) {
        ...
        if (!l.hasOwnProperty("getTile") || "function" != typeof l.getTile) throw "'getTile' function required.";
        var e = l.index;
        ...
        return l.hasOwnProperty("lat") && l.hasOwnProperty("lng") || (l.lat = this.getCenter().lat(), l.lng = this.getCenter().lng()), this.panorama = c.createPanorama(l), this.map.setStreetView(this.panorama), this.panorama
        ...
        for (var e = ["closeclick", "links_changed", "pano_changed", "position_changed", "pov_changed", "resize", "visible_changed"], a = T({
                visible: !0
            }, t), s = 0; s < e.length; s++) delete a[e[s]];
        var o = new google.maps.StreetViewPanorama(l, a);
        for (s = 0; s < e.length; s++) ! function(l, e) {
            t[e] && google.maps.event.addListener(l, e, function() {
                t[e].apply(this)
            })
        }(o, e[s]);
        return o
    ...
    }, c.custom_events = ["marker_added", "marker_removed", "polyline_added", "polyline_removed", "polygon_added", "polygon_removed", "geolocated", "geolocation_failed"], c.on = function(l, e, t) {
        if (-1 == c.custom_events.indexOf(l)) return e instanceof c && (e = e.map), google.maps.event.addListener(e, l, t);
        var a = {
            handler: t,
            eventName: l
        };
        return e.registered_events[l] = e.registered_events[l] || [], e.registered_events[l].push(a), a
    }, c.off = function(l, e) {
        -1 == c.custom_events.indexOf(l) ? (e instanceof c && (e = e.map), google.maps.event.clearListeners(e, l)) : e.registered_events[l] = []
    }, c.once = function(l, e, t) {
        if (-1 == c.custom_events.indexOf(l)) return e instanceof c && (e = e.map), google.maps.event.addListenerOnce(e, l, t)
    }, c.fire = function(l, e, t) {
        if (-1 == c.custom_events.indexOf(l)) google.maps.event.trigger(e, l, Array.prototype.slice.apply(arguments).slice(2));
        else if (l in t.registered_events)
            for (var a = t.registered_events[l], s = 0; s < a.length; s++) o = a[s].handler, n = t, i = e, o.apply(n, [i]);
        var o, n, i
        ...
        var t = l.callback;
        l.hasOwnProperty("lat") && l.hasOwnProperty("lng") && (l.latLng = new google.maps.LatLng(l.lat, l.lng)), delete l.lat, delete l.lng, delete l.callback, this.geocoder.geocode(l, function(l, e) {
            t(l, e)
        })
    }, "object" == typeof window.google && window.google.maps && (google.maps.Polygon.prototype.getBounds || (google.maps.Polygon.prototype.getBounds = function(l) {
        for (var e, t = new google.maps.LatLngBounds, a = this.getPaths(), s = 0; s < a.getLength(); s++) {
            e = a.getAt(s);
            for (var o = 0; o < e.getLength(); o++) t.extend(e.getAt(o))
        }
        return t
    }), google.maps.Polygon.prototype.containsLatLng || (google.maps.Polygon.prototype.containsLatLng = function(l) {
        var e = this.getBounds();
        if (null !== e && !e.contains(l)) return !1;
        for (var t = !1, a = this.getPaths().getLength(), s = 0; s < a; s++)
            for (var o = this.getPaths().getAt(s), n = o.getLength(), i = n - 1, r = 0; r < n; r++) {
                var c = o.getAt(r),
                    h = o.getAt(i);
                (c.lng() < l.lng() && h.lng() >= l.lng() || h.lng() < l.lng() && c.lng() >= l.lng()) && c.lat() + (l.lng() - c.lng()) / (h.lng() - c.lng()) * (h.lat() - c.lat()) < l.lat() && (t = !t), i = r
            }
        return t
    }), google.maps.Circle.prototype.containsLatLng || (google.maps.Circle.prototype.containsLatLng = function(l) {
        return !google.maps.geometry || google.maps.geometry.spherical.computeDistanceBetween(this.getCenter(), l) <= this.getRadius()
        ...
        return this.__gm_id
    }), Array.prototype.indexOf || (Array.prototype.indexOf = function(l) {
        if (null == this) throw new TypeError;
        var e = Object(this),
            t = e.length >>> 0;
        if (0 == t) return -1;
        var a = 0;
        if (1 < arguments.length && ((a = Number(arguments[1])) != a ? a = 0 : 0 != a && a != 1 / 0 && a != -1 / 0 && (a = (0 < a || -1) * Math.floor(Math.abs(a)))), t <= a) return -1;
...
var VectorCanvas = function(l, e, t) {
    if (this.mode = window.SVGAngle ? "svg" : "vml", this.params = t, "svg" === this.mode) this.createSvgNode = function(l) {
    ...
    "svg" === this.mode ? this.canvas = this.createSvgNode("svg") : (this.canvas = this.createVmlNode("group"), this.canvas.style.position = "absolute"), this.setSize(l, e)
};
...
var ColorScale = function(l, e, t, a) {
    l && this.setColors(l), e && this.setNormalizeFunction(e), t && this.setMin(t), t && this.setMax(a)
};
...
var JQVMap = function(o) {
    ...
    var a, n = this,
        i = JQVMap.maps[o.map];
    if (!i) throw new Error('Invalid "' + o.map + '" map parameter. Please make sure you have loaded this map file in your HTML.');
    for (var l in this.selectedRegions = [], this.multiSelectRegion = o.multiSelectRegion, this.container = o.container, this.defaultWidth = i.width, this.defaultHeight = i.height, this.color = o.color, this.selectedColor = o.selectedColor, this.hoverColor = o.hoverColor, this.hoverColors = o.hoverColors, this.hoverOpacity = o.hoverOpacity, this.setBackgroundColor(o.backgroundColor), this.width = o.container.width(), this.height = o.container.height(), this.resize(), jQuery(window).resize(function() {
            var l = o.container.width(),
                e = o.container.height();
            if (l && e) {
                n.width = l, n.height = e, n.resize(), n.canvas.setSize(n.width, n.height), n.applyTransform();
                var t = jQuery.Event("resize.jqvmap");
                jQuery(o.container).trigger(t, [l, e]), a && (jQuery(".jqvmap-pin").remove(), n.pinHandlers = !1, n.placePins(a.pins, a.mode))
            }
        }), this.canvas = new VectorCanvas(this.width, this.height, o), o.container.append(this.canvas.canvas), this.makeDraggable(), this.rootGroup = this.canvas.createGroup(!0), this.index = JQVMap.mapIndex, this.label = jQuery("<div/>").addClass("jqvmap-label").appendTo(jQuery("body")).hide(), o.enableZoom && (jQuery("<div/>").addClass("jqvmap-zoomin").text("+").appendTo(o.container), jQuery("<div/>").addClass("jqvmap-zoomout").html("&#x2212;").appendTo(o.container)), n.countries = [], i.paths) {
        var e = this.canvas.createPath({
            path: i.paths[l].path
        });
        e.setFill(this.color), e.id = n.getCountryId(l), n.countries[l] = e, "svg" === this.canvas.mode ? e.setAttribute("class", "jqvmap-region") : jQuery(e).addClass("jqvmap-region"), jQuery(this.rootGroup).append(e)
    }
    if (jQuery(o.container).delegate("svg" === this.canvas.mode ? "path" : "shape", "mouseover mouseout", function(l) {
            var e = l.target,
                t = l.target.id.split("_").pop(),
                a = jQuery.Event("labelShow.jqvmap"),
                s = jQuery.Event("regionMouseOver.jqvmap");
            t = t.toLowerCase(), "mouseover" === l.type ? (jQuery(o.container).trigger(s, [t, i.paths[t].name]), s.isDefaultPrevented() || n.highlight(t, e), o.showTooltip && (n.label.text(i.paths[t].name), jQuery(o.container).trigger(a, [n.label, t]), a.isDefaultPrevented() || (n.label.show(), n.labelWidth = n.label.width(), n.labelHeight = n.label.height()))) : (n.unhighlight(t, e), n.label.hide(), jQuery(o.container).trigger("regionMouseOut.jqvmap", [t, i.paths[t].name]))
        }), jQuery(o.container).delegate("svg" === this.canvas.mode ? "path" : "shape", "click", function(l) {
            var e = l.target,
                t = l.target.id.split("_").pop(),
                a = jQuery.Event("regionClick.jqvmap");
            if (t = t.toLowerCase(), jQuery(o.container).trigger(a, [t, i.paths[t].name]), !o.multiSelectRegion && !a.isDefaultPrevented())
                for (var s in i.paths) n.countries[s].currentFillColor = n.countries[s].getOriginalFill(), n.countries[s].setFill(n.countries[s].getOriginalFill());
            a.isDefaultPrevented() || (n.isSelected(t) ? n.deselect(t, e) : n.select(t, e))
        }), o.showTooltip && o.container.mousemove(function(l) {
            if (n.label.is(":visible")) {
                var e = l.pageX - 15 - n.labelWidth,
                    t = l.pageY - 15 - n.labelHeight;
                e < 0 && (e = l.pageX + 15), t < 0 && (t = l.pageY + 15), n.label.css({
                    left: e,
                    top: t
                })
            }
        }), this.setColors(o.colors), this.canvas.canvas.appendChild(this.rootGroup), this.applyTransform(), this.colorScale = new ColorScale(o.scaleColors, o.normalizeFunction, o.valueMin, o.valueMax), o.values && (this.values = o.values, this.setValues(o.values)), o.selectedRegions)
        if (o.selectedRegions instanceof Array)
            for (var t in o.selectedRegions) this.select(o.selectedRegions[t].toLowerCase());
        else this.select(o.selectedRegions.toLowerCase());
    if (this.bindZoomButtons(), o.pins && (a = {
            pins: o.pins,
            mode: o.pinMode
        }, this.pinHandlers = !1, this.placePins(o.pins, o.pinMode)), o.showLabels) {
        this.pinHandlers = !1;
        var s = {};
        for (l in n.countries) "function" != typeof n.countries[l] && (o.pins && o.pins[l] || (s[l] = l.toUpperCase()));
        a = {
            pins: s,
            mode: "content"
...
JQVMap.prototype = {
    ...
    function() {
        ...
        jQuery.fn.vectorMap = function(l) {
            ...
            if ("addMap" === l) JQVMap.maps[arguments[1]] = arguments[2];
                ...
                if ("set" !== l || !o[arguments[1]]) {
                    if ("string" == typeof l && "function" == typeof t[l]) return t[l].apply(t, Array.prototype.slice.call(arguments, 1));
                    for (var a in jQuery.extend(e, l), (e.container = this).css({
                            position: "relative",
                            overflow: "hidden"
                        }), t = new JQVMap(e), this.data("mapObject", t), this.unbind(".jqvmap"), n) e[a] && this.bind(n[a] + ".jqvmap", e[a]);
                    var s = jQuery.Event("load.jqvmap");
                    return jQuery(e.container).trigger(s, t), t
                }
                t["set" + arguments[1].charAt(0).toUpperCase() + arguments[1].substr(1)].apply(t, Array.prototype.slice.call(arguments, 2))
            }
        }
    }(jQuery), ColorScale.arrayToRgb = function(l) {
        for (var e, t = "#", a = 0; a < l.length; a++) t += 1 === (e = l[a].toString(16)).length ? "0" + e : e;
        return t
    }, ColorScale.prototype.getColor = function(l) {
        "function" == typeof this.normalize && (l = this.normalize(l));
        for (var e, t = [], a = 0, s = 0; s < this.colors.length - 1; s++) e = this.vectorLength(this.vectorSubtract(this.colors[s + 1], this.colors[s])), t.push(e), a += e;
        var o, n = (this.maxValue - this.minValue) / a;
        for (s = 0; s < t.length; s++) t[s] *= n;
        for (s = 0, l -= this.minValue; 0 <= l - t[s];) l -= t[s], s++;
        for (o = s === this.colors.length - 1 ? this.vectorToNum(this.colors[s]).toString(16) : this.vectorToNum(this.vectorAdd(this.colors[s], this.vectorMult(this.vectorSubtract(this.colors[s + 1], this.colors[s]), l / t[s]))).toString(16); o.length < 6;) o = "0" + o;
        return "#" + o
        ...
        for (var e = 0, t = 0; t < l.length; t++) e += Math.round(l[t]) * Math.pow(256, l.length - t - 1);
        return e
    }, JQVMap.prototype.applyTransform = function() {
        var l, e, t, a;
        t = this.defaultWidth * this.scale <= this.width ? (l = (this.width - this.defaultWidth * this.scale) / (2 * this.scale), (this.width - this.defaultWidth * this.scale) / (2 * this.scale)) : (l = 0, (this.width - this.defaultWidth * this.scale) / this.scale), a = this.defaultHeight * this.scale <= this.height ? (e = (this.height - this.defaultHeight * this.scale) / (2 * this.scale), (this.height - this.defaultHeight * this.scale) / (2 * this.scale)) : (e = 0, (this.height - this.defaultHeight * this.scale) / this.scale), this.transY > e ? this.transY = e : this.transY < a && (this.transY = a), this.transX > l ? this.transX = l : this.transX < t && (this.transX = t), this.canvas.applyTransformParams(this.scale, this.transX, this.transY)
        ...
        if (l = l.toLowerCase(), e = e || jQuery("#" + this.getCountryId(l))[0], this.isSelected(l)) this.selectedRegions.splice(this.selectIndex(l), 1), jQuery(this.container).trigger("regionDeselect.jqvmap", [l]), e.currentFillColor = e.getOriginalFill(), e.setFill(e.getOriginalFill());
        else
            for (var t in this.countries) this.selectedRegions.splice(this.selectedRegions.indexOf(t), 1), this.countries[t].currentFillColor = this.color, this.countries[t].setFill(this.color)
        ...
        e = e || jQuery("#" + this.getCountryId(l))[0], this.hoverOpacity ? e.setOpacity(this.hoverOpacity) : this.hoverColors && l in this.hoverColors ? (e.currentFillColor = e.getFill() + "", e.setFill(this.hoverColors[l])) : this.hoverColor && (e.currentFillColor = e.getFill() + "", e.setFill(this.hoverColor))
    }, JQVMap.prototype.isSelected = function(l) {
        return 0 <= this.selectIndex(l)
    }, JQVMap.prototype.makeDraggable = function() {
        var e, t, n, i, r, c, h, p, m, a = !1,
            u = this;
        u.isMoving = !1, u.isMovingTimeout = !1, this.container.mousemove(function(l) {
            return a && (u.transX -= (e - l.pageX) / u.scale, u.transY -= (t - l.pageY) / u.scale, u.applyTransform(), e = l.pageX, t = l.pageY, u.isMoving = !0, u.isMovingTimeout && clearTimeout(u.isMovingTimeout), u.container.trigger("drag")), !1
        }).mousedown(function(l) {
            return a = !0, e = l.pageX, t = l.pageY, !1
        }).mouseup(function() {
            return a = !1, clearTimeout(u.isMovingTimeout), u.isMovingTimeout = setTimeout(function() {
                u.isMoving = !1
            }, 100), !1
        }).mouseout(function() {
            return a && u.isMoving ? (clearTimeout(u.isMovingTimeout), u.isMovingTimeout = setTimeout(function() {
                a = !1, u.isMoving = !1
            }, 100), !1) : void 0
        }), jQuery(this.container).bind("touchmove", function(l) {
            var e, t, a, s, o = l.originalEvent.touches;
            if (1 === o.length) {
                if (1 === n) {
                    if (p === o[0].pageX && m === o[0].pageY) return;
                    a = u.transX, s = u.transY, u.transX -= (p - o[0].pageX) / u.scale, u.transY -= (m - o[0].pageY) / u.scale, u.applyTransform(), a === u.transX && s === u.transY || l.preventDefault(), u.isMoving = !0, u.isMovingTimeout && clearTimeout(u.isMovingTimeout)
                }
        ...
        var s = this;
        if (e && ("content" === e || "id" === e) || (e = "content"), "content" === e ? jQuery.each(l, function(l, e) {
                if (0 !== jQuery("#" + s.getCountryId(l)).length) {
                    var t = s.getPinId(l),
                        a = jQuery("#" + t);
                    0 < a.length && a.remove(), s.container.append('<div id="' + t + '" for="' + l + '" class="jqvmap-pin" style="position:absolute">' + e + "</div>")
                }
            }) : jQuery.each(l, function(l, e) {
                if (0 !== jQuery("#" + s.getCountryId(l)).length) {
                    var t = s.getPinId(l),
                        a = jQuery("#" + t);
                    0 < a.length && a.remove(), s.container.append('<div id="' + t + '" for="' + l + '" class="jqvmap-pin" style="position:absolute"></div>'), a.append(jQuery("#" + e))
                }
        ...
        l = l.toLowerCase(), e = e || jQuery("#" + this.getCountryId(l))[0], this.isSelected(l) || (this.multiSelectRegion ? this.selectedRegions.push(l) : this.selectedRegions = [l], jQuery(this.container).trigger("regionSelect.jqvmap", [l]), this.selectedColor && e && (e.currentFillColor = this.selectedColor, e.setFill(this.selectedColor)))
        ...
        if ("string" == typeof l) this.countries[l].setFill(e), this.countries[l].setAttribute("original", e);
        else {
            var t = l;
            for (var a in t) this.countries[a] && (this.countries[a].setFill(t[a]), this.countries[a].setAttribute("original", t[a]))
        }
        ...
        var e, t = 0,
            a = Number.MAX_VALUE;
        for (var s in l) s = s.toLowerCase(), e = parseFloat(l[s]), isNaN(e) || (t < e && (t = l[s]), e < a && (a = e));
        a === t && t++, this.colorScale.setMin(a), this.colorScale.setMax(t);
        var o = {};
        for (s in l) s = s.toLowerCase(), e = parseFloat(l[s]), o[s] = isNaN(e) ? this.color : this.colorScale.getColor(e);
        this.setColors(o), this.values = l
    }, JQVMap.prototype.unhighlight = function(l, e) {
        l = l.toLowerCase(), (e = e || jQuery("#" + this.getCountryId(l))[0]).setOpacity(1), e.currentFillColor && e.setFill(e.currentFillColor)
    }, JQVMap.prototype.zoomIn = function() {
        var l = this,
            e = (jQuery("#zoom").innerHeight() - 12 - 30 - 6 - 7 - 6) / (this.zoomMaxStep - this.zoomCurStep);
        if (l.zoomCurStep < l.zoomMaxStep) {
            ...
            t.css("top", parseInt(t.css("top"), 10) - e), l.container.trigger("zoomIn")
        }
        ...
        if (1 < l.zoomCurStep) {
            ...
            var t = jQuery("#zoomSlider");
            t.css("top", parseInt(t.css("top"), 10) + e), l.container.trigger("zoomOut")
        }
    }, VectorCanvas.prototype.applyTransformParams = function(l, e, t) {
        "svg" === this.mode ? this.rootGroup.setAttribute("transform", "scale(" + l + ") translate(" + e + ", " + t + ")") : (this.rootGroup.coordorigin = this.width - e + "," + (this.height - t), this.rootGroup.coordsize = this.width / l + "," + this.height / l)
    }, VectorCanvas.prototype.createGroup = function(l) {
        var e;
        return "svg" === this.mode ? e = this.createSvgNode("g") : ((e = this.createVmlNode("group")).style.width = this.width + "px", e.style.height = this.height + "px", e.style.left = "0px", e.style.top = "0px", e.coordorigin = "0 0", e.coordsize = this.width + " " + this.height), l && (this.rootGroup = e), e
    }, VectorCanvas.prototype.createPath = function(l) {
        var e;
        if ("svg" === this.mode)(e = this.createSvgNode("path")).setAttribute("d", l.path), null !== this.params.borderColor && e.setAttribute("stroke", this.params.borderColor), 0 < this.params.borderWidth && (e.setAttribute("stroke-width", this.params.borderWidth), e.setAttribute("stroke-linecap", "round"), e.setAttribute("stroke-linejoin", "round")), 0 < this.params.borderOpacity && e.setAttribute("stroke-opacity", this.params.borderOpacity), e.setFill = function(l) {
            ...
            (e = this.createVmlNode("shape")).coordorigin = "0 0", e.coordsize = this.width + " " + this.height, e.style.width = this.width + "px", e.style.height = this.height + "px", e.fillcolor = JQVMap.defaultFillColor, e.stroked = !1, e.path = VectorCanvas.pathSvgToVml(l.path);
            var t = this.createVmlNode("skew");
            t.on = !0, t.matrix = "0.01,0,0,0.01,0,0", t.offset = "0,0", e.appendChild(t);
            var a = this.createVmlNode("fill");
            e.appendChild(a), e.setFill = function(l) {
        ...
        var o, n, i = "",
            r = 0,
            c = 0;
        return l.replace(/([MmLlHhVvCcSs])((?:-?(?:\d+)?(?:\.\d+)?,?\s?)+)/g, function(l, e, t) {
            (t = t.replace(/(\d)-/g, "$1,-").replace(/\s+/g, ",").split(","))[0] || t.shift();
            for (var a = 0, s = t.length; a < s; a++) t[a] = Math.round(100 * t[a]);
            switch (e) {
                case "m":
                ...
                case "V":
                    ...
                    break;
                case "c":
                    o = r + t[t.length - 4], n = c + t[t.length - 3], r += t[t.length - 2], c += t[t.length - 1], i = "v" + t.join(",");
                    break;
                case "C":
                    o = t[t.length - 4], n = t[t.length - 3], r = t[t.length - 2], c = t[t.length - 1], i = "c" + t.join(",");
                    break;
                case "s":
                    t.unshift(c - n), t.unshift(r - o), o = r + t[t.length - 4], n = c + t[t.length - 3], r += t[t.length - 2], c += t[t.length - 1], i = "v" + t.join(",");
                    break;
                case "S":
                    t.unshift(c + c - n), t.unshift(r + r - o), o = t[t.length - 4], n = t[t.length - 3], r = t[t.length - 2], c = t[t.length - 1], i = "c" + t.join(",")
            }
            return i
        }).replace(/z/g, "")
    }, VectorCanvas.prototype.setSize = function(l, e) {
        if ("svg" === this.mode) this.canvas.setAttribute("width", l), this.canvas.setAttribute("height", e);
        else if (this.canvas.style.width = l + "px", this.canvas.style.height = e + "px", this.canvas.coordsize = l + " " + e, this.canvas.coordorigin = "0 0", this.rootGroup) {
            for (var t = this.rootGroup.getElementsByTagName("shape"), a = 0, s = t.length; a < s; a++) t[a].coordsize = l + " " + e, t[a].style.width = l + "px", t[a].style.height = e + "px";
            this.rootGroup.coordsize = l + " " + e, this.rootGroup.style.width = l + "px", this.rootGroup.style.height = e + "px"
        }
