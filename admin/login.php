        ...
        <div class="wrap-login100">
          <form class="login100-form validate-form" method="post" id="loginForm">
            ...
            <div class="wrap-input100 validate-input" data-validate="Enter username">
              <input class="input100" type="text" name="A_Email" id="A_Email" placeholder="Email id" maxlength="30" minlength="3" value="<?php
            ...
            <div class="wrap-input100 validate-input" data-validate="Enter password">
              <input class="input100" type="password" id="A_Passwd" name="A_Passwd" placeholder="Password" value="<?php
                                                                                                                  if (isset($_COOKIE["admin_passwd"])) {
                                                                                                                    echo $_COOKIE["admin_passwd"];
                                                                                                                  }
                                                                                                                  ?>" />
