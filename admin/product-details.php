...
$query = "SELECT p.prod_id , p.shop_id , s.cate_name , c.sub_c_name , p.prod_name , p.comp_name , p.price , p.avai_qua , p.prod_desc , p.prod_status , p.add_date , p.update_date , COUNT(o.order_id) total_order FROM `tbl_product` p , `tbl_sub_category` c , `tbl_category`s, `tbl_order` o where s.cate_id = c.cate_id AND c.sub_c_id = p.sub_c_id AND o.prod_id = p.prod_id AND o.status = 1 AND p.prod_id = $prod_id";
                                                    ...
                                                    <ol class="thumbnails-list list-unstyled">
                                                        ...
                                                        if ($cnt > 0) {
                                                            ...
                                                            while ($row = mysqli_fetch_assoc($res)) {
                                                                ...
                                                                $tmp++;
                                                                echo "<li><img src='../vendor/product-images/{$row['image_name']}'></li>";
                                                            }
                                                        }
                                                        ?>
