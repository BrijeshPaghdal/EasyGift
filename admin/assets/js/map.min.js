...
!(function (l, e) {
  'object' == typeof exports
    ...
    ? define(['jquery', 'googlemaps!'], e)
    : (l.GMaps = e());
})(this, function () {
  function T(l, e) {
    var t;
    if (l === e) return l;
    for (t in e) void 0 !== e[t] && (l[t] = e[t]);
    return l;
  }
  function o(l, t) {
    var e,
      ...
      s = [],
      o = l.length;
    if (Array.prototype.map && l.map === Array.prototype.map)
      s = Array.prototype.map.call(l, function (l) {
        var e = a.slice(0);
        return e.splice(0, 0, l), t.apply(this, e);
      });
    else
      for (e = 0; e < o; e++)
        (callback_params = a),
          callback_params.splice(0, 0, l[e]),
          s.push(t.apply(this, callback_params));
    return s;
  }
  function n(l) {
    var e,
      t = [];
    for (e = 0; e < l.length; e++) t = t.concat(l[e]);
    return t;
  }
  function j(l, e) {
    return (
      (l = l.replace('#', '')),
      'jQuery' in window && e ? $('#' + l, e)[0] : document.getElementById(l)
    );
  }
  var P,
    _,
    ...
    r = function (l, e) {
      ...
      for (t = 0; t < l.length; t++)
        l[t] instanceof google.maps.LatLng ||
          (0 < l[t].length && 'object' == typeof l[t][0]
            ? (l[t] = r(l[t], e))
            : (l[t] =
                ((a = l[t]),
                (s = e),
    ...
    c =
      ...
      (_ = function (t) {
        ...
        var e,
          ...
          n = t.el || t.div,
          i = t.markerClusterer,
          r = google.maps.MapTypeId[t.mapType.toUpperCase()],
          c = new google.maps.LatLng(t.lat, t.lng),
          h = l(t.zoomControl, !0),
          p = t.zoomControlOpt || { style: 'DEFAULT', position: 'TOP_LEFT' },
          m = p.style || 'DEFAULT',
          g = p.position || 'TOP_LEFT',
          L = l(t.panControl, !0),
          d = l(t.mapTypeControl, !0),
          v = l(t.scaleControl, !0),
          z = l(t.streetViewControl, !0),
          f = l(f, !0),
          y = {},
          M = { zoom: this.zoom, center: c, mapTypeId: r },
          b = {
            panControl: L,
            zoomControl: h,
            zoomControlOptions: {
              style: google.maps.ZoomControlStyle[m],
              position: google.maps.ControlPosition[g],
            },
            mapTypeControl: d,
            scaleControl: v,
            streetViewControl: z,
        ...
        if (
          ('string' == typeof t.el || 'string' == typeof t.div
            ? -1 < n.indexOf('#')
              ? (this.el = j(n, t.context))
              : (this.el = function (l, e) {
                  var t = l.replace('.', '');
                  return 'jQuery' in this && e
                    ? $('.' + t, e)[0]
                    : document.getElementsByClassName(t)[0];
                }.apply(this, [n, t.context]))
            : (this.el = n),
        ...
        for (
          ...
          delete t[o[e]];
        for (
          1 != t.disableDefaultUI && (M = T(M, b)), y = T(M, t), e = 0;
          e < a.length;
          e++
        )
          delete y[a[e]];
        for (e = 0; e < s.length; e++) delete y[s[e]];
        (this.map = new google.maps.Map(this.el, y)),
          i && (this.markerClusterer = i.apply(this, [this.map]));
        function w(e, t) {
          var l = '',
            a = window.context_menu[u.el.id][e];
          for (var s in a)
          ...
          if (j('gmaps_context_menu')) {
            var n = j('gmaps_context_menu');
            n.innerHTML = l;
            ...
            for (s = 0; s < r; s++) {
              ...
              google.maps.event.clearListeners(c, 'click'),
                google.maps.event.addDomListenerOnce(
                  ...
                  function (l) {
                    l.preventDefault(),
                      a[this.id.replace(e + '_', '')].action.apply(u, [t]),
                      u.hideContextMenu();
                  },
                  !1
                );
            ...
            var h = function (l) {
              ...
              p = h[0] + t.pixel.x - 15,
              m = h[1] + t.pixel.y - 15;
            (n.style.left = p + 'px'), (n.style.top = m + 'px');
          }
        }
        (this.buildContextMenu = function (t, a) {
          if ('marker' === t) {
            a.pixel = {};
            var s = new google.maps.OverlayView();
            s.setMap(u.map),
              (s.draw = function () {
                var l = s.getProjection(),
                  e = a.marker.getPosition();
                (a.pixel = l.fromLatLngToContainerPixel(e)), w(t, a);
              });
          } else w(t, a);
          var l = j('gmaps_context_menu');
          setTimeout(function () {
            l.style.display = 'block';
          }, 0);
        }),
          (this.setContextMenu = function (l) {
            window.context_menu[u.el.id][l.control] = {};
            var e,
              t = P.createElement('ul');
            for (e in l.options)
              if (l.options.hasOwnProperty(e)) {
                var a = l.options[e];
                window.context_menu[u.el.id][l.control][a.name] = {
                  title: a.title,
                  action: a.action,
                };
              }
            (t.id = 'gmaps_context_menu'),
              ...
              (t.style.padding = '8px'),
              (t.style.boxShadow = '2px 2px 6px #ccc'),
              j('gmaps_context_menu') || P.body.appendChild(t);
            var s = j('gmaps_context_menu');
            google.maps.event.addDomListener(
              s,
              'mouseout',
              function (l) {
                (l.relatedTarget && this.contains(l.relatedTarget)) ||
        ...
        function k(l, e) {
          google.maps.event.addListener(l, e, function (l) {
            null == l && (l = this), t[e].apply(this, [l]), u.hideContextMenu();
          });
        }
        ...
        for (var C = 0; C < a.length; C++) {
          (S = a[C]) in t && k(this.map, S);
        }
        for (C = 0; C < s.length; C++) {
          var S;
          (S = s[C]) in t && k(this.map, S);
        }
        google.maps.event.addListener(this.map, 'rightclick', function (l) {
          t.rightclick && t.rightclick.apply(this, [l]),
            null != window.context_menu[u.el.id].map &&
              u.buildContextMenu('map', l);
        }),
          ...
          (this.fitZoom = function () {
            ...
            for (l = 0; l < t; l++)
              'boolean' == typeof this.markers[l].visible &&
                this.markers[l].visible &&
                e.push(this.markers[l].getPosition());
          ...
          (this.fitLatLngBounds = function (l) {
            ...
            for (e = 0; e < t; e++) a.extend(l[e]);
            this.map.fitBounds(a);
          }),
          (this.setCenter = function (l, e, t) {
            this.map.panTo(new google.maps.LatLng(l, e)), t && t();
          }),
        ...
        var O,
          x = [];
        for (O in this.map)
          'function' != typeof this.map[O] || this[O] || x.push(O);
  ...
  return (
    (c.prototype.createControl = function (t) {
      var l = document.createElement('div');
      for (var e in ((l.style.cursor = 'pointer'),
      !0 !== t.disableDefaultStyles &&
        ((l.style.fontFamily = 'Roboto, Arial, sans-serif'),
        (l.style.fontSize = '11px'),
        (l.style.boxShadow = 'rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px')),
      t.style))
        l.style[e] = t.style[e];
      for (var a in (t.id && (l.id = t.id),
      t.title && (l.title = t.title),
      t.classes && (l.className = t.classes),
      t.content &&
        ('string' == typeof t.content
          ? (l.innerHTML = t.content)
          : t.content instanceof HTMLElement && l.appendChild(t.content)),
      t.position &&
        (l.position = google.maps.ControlPosition[t.position.toUpperCase()]),
      t.events))
        !(function (l, e) {
          google.maps.event.addDomListener(l, e, function () {
            t.events[e].apply(this, [this]);
          });
        })(l, a);
      return (l.index = 1), l;
    }),
    (c.prototype.addControl = function (l) {
      var e = this.createControl(l);
      return this.controls.push(e), this.map.controls[e.position].push(e), e;
    }),
    (c.prototype.removeControl = function (l) {
      var e,
        t = null;
      for (e = 0; e < this.controls.length; e++)
        this.controls[e] == l &&
          ((t = this.controls[e].position), this.controls.splice(e, 1));
      if (t)
        for (e = 0; e < this.map.controls.length; e++) {
          var a = this.map.controls[l.position];
          if (a.getAt(e) == l) {
            a.removeAt(e);
            break;
          }
    ...
    (c.prototype.createMarker = function (a) {
      if (null == a.lat && null == a.lng && null == a.position)
        throw 'No latitude or longitude defined.';
      var e = this,
        l = a.details,
        t = a.fences,
        s = a.outside,
        o = { position: new google.maps.LatLng(a.lat, a.lng), map: null },
        n = T(o, a);
      delete n.lat, delete n.lng, delete n.fences, delete n.outside;
      var i = new google.maps.Marker(n);
      if (((i.fences = t), a.infoWindow)) {
        i.infoWindow = new google.maps.InfoWindow(a.infoWindow);
        for (
          var r = [
              'closeclick',
              'content_changed',
      ...
      for (c = 0; c < h.length; c++)
        !(function (l, e) {
          a[e] &&
            google.maps.event.addListener(l, e, function () {
              a[e].apply(this, [this]);
            });
        })(i, h[c]);
      for (c = 0; c < p.length; c++)
        !(function (e, l, t) {
          a[t] &&
            google.maps.event.addListener(l, t, function (l) {
              l.pixel ||
                (l.pixel = e.getProjection().fromLatLngToPoint(l.latLng)),
                a[t].apply(this, [l]);
            });
        })(this.map, i, p[c]);
      return (
        google.maps.event.addListener(i, 'click', function () {
          (this.details = l),
            ...
            i.infoWindow && (e.hideInfoWindows(), i.infoWindow.open(e.map, i));
        }),
        google.maps.event.addListener(i, 'rightclick', function (l) {
          (l.marker = this),
            a.rightclick && a.rightclick.apply(this, [l]),
            null != window.context_menu[e.el.id].marker &&
              e.buildContextMenu('marker', l);
        }),
        i.fences &&
          google.maps.event.addListener(i, 'dragend', function () {
            e.checkMarkerGeofence(i, function (l, e) {
              s(l, e);
            });
          }),
        i
    ...
    (c.prototype.addMarker = function (l) {
      var e;
      if (l.hasOwnProperty('gm_accessors_')) e = l;
      else {
        if (
          !((l.hasOwnProperty('lat') && l.hasOwnProperty('lng')) || l.position)
        )
          throw 'No latitude or longitude defined.';
        e = this.createMarker(l);
      }
      return (
        e.setMap(this.map),
        this.markerClusterer && this.markerClusterer.addMarker(e),
        this.markers.push(e),
        c.fire('marker_added', e, this),
        e
      );
    }),
    (c.prototype.addMarkers = function (l) {
      for (var e, t = 0; (e = l[t]); t++) this.addMarker(e);
      return this.markers;
    }),
    (c.prototype.hideInfoWindows = function () {
      for (var l, e = 0; (l = this.markers[e]); e++)
        l.infoWindow && l.infoWindow.close();
    }),
    (c.prototype.removeMarker = function (l) {
      for (var e = 0; e < this.markers.length; e++)
        if (this.markers[e] === l) {
          this.markers[e].setMap(null),
            this.markers.splice(e, 1),
            this.markerClusterer && this.markerClusterer.removeMarker(l),
            c.fire('marker_removed', l, this);
          break;
        }
      return l;
    }),
    (c.prototype.removeMarkers = function (l) {
      var e = [];
      if (void 0 === l) {
        for (var t = 0; t < this.markers.length; t++) {
          (s = this.markers[t]).setMap(null), c.fire('marker_removed', s, this);
        }
        ...
        for (t = 0; t < l.length; t++) {
          var a = this.markers.indexOf(l[t]);
          if (-1 < a)
            (s = this.markers[a]).setMap(null),
              this.markerClusterer && this.markerClusterer.removeMarker(s),
              c.fire('marker_removed', s, this);
        }
        for (t = 0; t < this.markers.length; t++) {
          var s;
          null != (s = this.markers[t]).getMap() && e.push(s);
        }
        this.markers = e;
      }
    }),
    (c.prototype.drawOverlay = function (n) {
      var i = new google.maps.OverlayView(),
        o = !0;
      return (
        i.setMap(this.map),
        null != n.auto_show && (o = n.auto_show),
        (i.onAdd = function () {
          var l = document.createElement('div');
          (l.style.borderStyle = 'none'),
            ...
            (i.el = l),
            n.layer || (n.layer = 'overlayLayer');
          var e,
            t,
            a = this.getPanes(),
            s = ['contextmenu', 'DOMMouseScroll', 'dblclick', 'mousedown'];
          a[n.layer].appendChild(l);
          for (var o = 0; o < s.length; o++)
            (e = l),
              (t = s[o]),
              google.maps.event.addDomListener(e, t, function (l) {
                -1 != navigator.userAgent.toLowerCase().indexOf('msie') &&
                document.all
                  ? ((l.cancelBubble = !0), (l.returnValue = !1))
                  : l.stopPropagation();
              });
          n.click &&
            (a.overlayMouseTarget.appendChild(i.el),
            google.maps.event.addDomListener(i.el, 'click', function () {
              n.click.apply(i, [i]);
            })),
            google.maps.event.trigger(this, 'ready');
        }),
        (i.draw = function () {
          var l = this.getProjection().fromLatLngToDivPixel(
            new google.maps.LatLng(n.lat, n.lng)
          );
          (n.horizontalOffset = n.horizontalOffset || 0),
            (n.verticalOffset = n.verticalOffset || 0);
          var e = i.el,
            t = e.children[0],
            a = t.clientHeight,
            s = t.clientWidth;
          switch (n.verticalAlign) {
            case 'top':
              e.style.top = l.y - a + n.verticalOffset + 'px';
              break;
            default:
            case 'middle':
              e.style.top = l.y - a / 2 + n.verticalOffset + 'px';
              break;
            case 'bottom':
              e.style.top = l.y + n.verticalOffset + 'px';
          }
          switch (n.horizontalAlign) {
            case 'left':
              e.style.left = l.x - s + n.horizontalOffset + 'px';
              break;
            default:
            case 'center':
              e.style.left = l.x - s / 2 + n.horizontalOffset + 'px';
              break;
            case 'right':
              e.style.left = l.x + n.horizontalOffset + 'px';
          }
          (e.style.display = o ? 'block' : 'none'),
            o || n.show.apply(this, [e]);
        }),
        (i.onRemove = function () {
          var l = i.el;
          n.remove
            ? n.remove.apply(this, [l])
            : (i.el.parentNode.removeChild(i.el), (i.el = null));
        }),
        this.overlays.push(i),
        i
      );
    }),
    (c.prototype.removeOverlay = function (l) {
      for (var e = 0; e < this.overlays.length; e++)
        if (this.overlays[e] === l) {
          this.overlays[e].setMap(null), this.overlays.splice(e, 1);
          break;
        }
    }),
    (c.prototype.removeOverlays = function () {
      for (var l, e = 0; (l = this.overlays[e]); e++) l.setMap(null);
      this.overlays = [];
    }),
    (c.prototype.drawPolyline = function (t) {
      ...
      if (e.length)
        if (void 0 === e[0][0]) l = e;
          ...
          for (var a, s = 0; (a = e[s]); s++)
            l.push(new google.maps.LatLng(a[0], a[1]));
      var o = {
        map: this.map,
        path: l,
      ...
      t.hasOwnProperty('clickable') && (o.clickable = t.clickable),
        t.hasOwnProperty('editable') && (o.editable = t.editable),
        t.hasOwnProperty('icons') && (o.icons = t.icons),
        t.hasOwnProperty('zIndex') && (o.zIndex = t.zIndex);
      for (
        var n = new google.maps.Polyline(o),
          i = [
            'click',
            'dblclick',
            'mousedown',
      ...
      return this.polylines.push(n), c.fire('polyline_added', n, this), n;
    }),
    (c.prototype.removePolyline = function (l) {
      for (var e = 0; e < this.polylines.length; e++)
        if (this.polylines[e] === l) {
          this.polylines[e].setMap(null),
            this.polylines.splice(e, 1),
            c.fire('polyline_removed', l, this);
          break;
        }
    }),
    (c.prototype.removePolylines = function () {
      for (var l, e = 0; (l = this.polylines[e]); e++) l.setMap(null);
      this.polylines = [];
    }),
    (c.prototype.drawCircle = function (t) {
      delete (t = T(
        ...
        delete t.lng;
      for (
        var l = new google.maps.Circle(t),
          e = [
            'click',
            'dblclick',
            'mousedown',
    ...
    (c.prototype.drawRectangle = function (t) {
      ...
      t.bounds = l;
      for (
        var e = new google.maps.Rectangle(t),
          a = [
            'click',
            'dblclick',
            'mousedown',
    ...
    (c.prototype.drawPolygon = function (t) {
      var l = !1;
      t.hasOwnProperty('useGeoJSON') && (l = t.useGeoJSON),
        delete t.useGeoJSON,
        (t = T({ map: this.map }, t)),
        0 == l && (t.paths = [t.paths.slice(0)]),
        0 < t.paths.length &&
          0 < t.paths[0].length &&
          (t.paths = n(o(t.paths, r, l)));
      for (
        var e = new google.maps.Polygon(t),
          a = [
            'click',
            'dblclick',
            'mousedown',
      ...
      return this.polygons.push(e), c.fire('polygon_added', e, this), e;
    }),
    (c.prototype.removePolygon = function (l) {
      for (var e = 0; e < this.polygons.length; e++)
        if (this.polygons[e] === l) {
          this.polygons[e].setMap(null),
            this.polygons.splice(e, 1),
            c.fire('polygon_removed', l, this);
          break;
        }
    }),
    (c.prototype.removePolygons = function () {
      for (var l, e = 0; (l = this.polygons[e]); e++) l.setMap(null);
      this.polygons = [];
    }),
    (c.prototype.getFromFusionTables = function (l) {
      var t = l.events;
      delete l.events;
      var e = l,
        a = new google.maps.FusionTablesLayer(e);
      for (var s in t)
        !(function (l, e) {
          google.maps.event.addListener(l, e, function (l) {
            t[e].apply(this, [l]);
    ...
    (c.prototype.loadFromFusionTables = function (l) {
      var e = this.getFromFusionTables(l);
      return e.setMap(this.map), e;
    }),
    (c.prototype.getFromKML = function (l) {
      var e = l.url,
        t = l.events;
      delete l.url, delete l.events;
      var a = l,
        s = new google.maps.KmlLayer(e, a);
      for (var o in t)
        !(function (l, e) {
          google.maps.event.addListener(l, e, function (l) {
            t[e].apply(this, [l]);
    ...
    (c.prototype.loadFromKML = function (l) {
      var e = this.getFromKML(l);
      return e.setMap(this.map), e;
    }),
    (c.prototype.addLayer = function (l, e) {
      var t;
      switch (((e = e || {}), l)) {
        case 'weather':
          this.singleLayers.weather = t = new google.maps.weather.WeatherLayer();
          break;
        case 'clouds':
          this.singleLayers.clouds = t = new google.maps.weather.CloudLayer();
          break;
        case 'traffic':
          this.singleLayers.traffic = t = new google.maps.TrafficLayer();
          break;
        case 'transit':
          this.singleLayers.transit = t = new google.maps.TransitLayer();
          break;
        case 'bicycling':
          this.singleLayers.bicycling = t = new google.maps.BicyclingLayer();
          break;
        case 'panoramio':
          (this.singleLayers.panoramio = t = new google.maps.panoramio.PanoramioLayer()),
            t.setTag(e.filter),
            delete e.filter,
            e.click &&
              google.maps.event.addListener(t, 'click', function (l) {
                e.click(l), delete e.click;
              });
          break;
        case 'places':
          if (
            ((this.singleLayers.places = t = new google.maps.places.PlacesService(
              this.map
            )),
            e.search || e.nearbySearch || e.radarSearch)
          ) {
            var a = {
            ...
            e.radarSearch && t.radarSearch(a, e.radarSearch),
              e.search && t.search(a, e.search),
              e.nearbySearch && t.nearbySearch(a, e.nearbySearch);
          }
          if (e.textSearch) {
            var s = {
              bounds: e.bounds || null,
            ...
            t.textSearch(s, e.textSearch);
          }
      }
      if (void 0 !== t)
        return (
          'function' == typeof t.setOptions && t.setOptions(e),
          'function' == typeof t.setMap && t.setMap(this.map),
          t
        );
    }),
    (c.prototype.removeLayer = function (l) {
      if ('string' == typeof l && void 0 !== this.singleLayers[l])
        this.singleLayers[l].setMap(null), delete this.singleLayers[l];
      else
    ...
    (c.prototype.getRoutes = function (a) {
      switch (a.travelMode) {
        case 'bicycling':
      ...
      (l.origin = /string/.test(typeof a.origin)
        ? a.origin
        : new google.maps.LatLng(a.origin[0], a.origin[1])),
        (l.destination = /string/.test(typeof a.destination)
          ? a.destination
        ...
        delete l.error;
      var s = [];
      new google.maps.DirectionsService().route(l, function (l, e) {
        if (e === google.maps.DirectionsStatus.OK) {
          for (var t in l.routes)
            l.routes.hasOwnProperty(t) && s.push(l.routes[t]);
          a.callback && a.callback(s, l, e);
        } else a.error && a.error(l, e);
      });
    }),
    (c.prototype.removeRoutes = function () {
      this.routes.length = 0;
    }),
    (c.prototype.getElevations = function (l) {
      0 <
        (l = T({ locations: [], path: !1, samples: 256 }, l)).locations
          .length &&
        0 < l.locations[0].length &&
        (l.locations = n(o([l.locations], r, !1)));
      var t = l.callback;
      delete l.callback;
      var e = new google.maps.ElevationService();
      if (l.path) {
        var a = { path: l.locations, samples: l.samples };
        e.getElevationAlongPath(a, function (l, e) {
          t && 'function' == typeof t && t(l, e);
        });
      } else
        delete l.path,
          delete l.samples,
          e.getElevationForLocations(l, function (l, e) {
            t && 'function' == typeof t && t(l, e);
          });
    }),
    (c.prototype.cleanRoute = c.prototype.removePolylines),
    (c.prototype.renderRoute = function (l, e) {
      var a,
        t =
          'string' == typeof e.panel
            ? document.getElementById(e.panel.replace('#', ''))
            : e.panel;
      (e.panel = t),
        (e = T({ map: this.map }, e)),
        (a = new google.maps.DirectionsRenderer(e)),
        this.getRoutes({
          origin: l.origin,
          destination: l.destination,
          travelMode: l.travelMode,
          waypoints: l.waypoints,
          unitSystem: l.unitSystem,
          error: l.error,
          avoidHighways: l.avoidHighways,
          avoidTolls: l.avoidTolls,
          optimizeWaypoints: l.optimizeWaypoints,
          callback: function (l, e, t) {
      ...
      this.getRoutes({
        ...
        callback: function (l) {
          if (0 < l.length) {
            ...
            t.hasOwnProperty('icons') && (e.icons = t.icons),
              a.drawPolyline(e),
              t.callback && t.callback(l[l.length - 1]);
          }
        },
      });
    }),
    (c.prototype.travelRoute = function (o) {
      if (o.origin && o.destination)
        this.getRoutes({
          ...
          callback: function (l) {
            if (
              (0 < l.length && o.start && o.start(l[l.length - 1]),
              0 < l.length && o.step)
            ) {
              var e = l[l.length - 1];
              if (0 < e.legs.length)
                for (var t, a = e.legs[0].steps, s = 0; (t = a[s]); s++)
                  (t.step_number = s), o.step(t, e.legs[0].steps.length - 1);
            }
            0 < l.length && o.end && o.end(l[l.length - 1]);
          },
        });
      else if (o.route && 0 < o.route.legs.length)
        for (var l, e = o.route.legs[0].steps, t = 0; (l = e[t]); t++)
          (l.step_number = t), o.step(l);
    }),
    (c.prototype.drawSteppedRoute = function (n) {
      var i = this;
      if (n.origin && n.destination)
        this.getRoutes({
          ...
          callback: function (l) {
            if (
              (0 < l.length && n.start && n.start(l[l.length - 1]),
              0 < l.length && n.step)
            ) {
              var e = l[l.length - 1];
              if (0 < e.legs.length)
                for (var t, a = e.legs[0].steps, s = 0; (t = a[s]); s++) {
                  ...
                  n.hasOwnProperty('icons') && (o.icons = n.icons),
                    i.drawPolyline(o),
                    n.step(t, e.legs[0].steps.length - 1);
                }
            }
            0 < l.length && n.end && n.end(l[l.length - 1]);
          },
        });
      else if (n.route && 0 < n.route.legs.length)
        for (var l, e = n.route.legs[0].steps, t = 0; (l = e[t]); t++) {
          l.step_number = t;
          var a = {
            path: l.path,
            strokeColor: n.strokeColor,
          ...
          n.hasOwnProperty('icons') && (a.icons = n.icons),
            i.drawPolyline(a),
            n.step(l);
        }
    }),
    (c.Route = function (l) {
      ...
      l.hasOwnProperty('icons') && (e.icons = l.icons),
        (this.polyline = this.map.drawPolyline(e).getPath());
    }),
    (c.Route.prototype.getRoute = function (l) {
      var t = this;
      this.map.getRoutes({
        origin: this.origin,
        ...
        error: l.error,
        callback: function () {
          (t.route = e[0]), l.callback && l.callback.call(t);
        },
      });
    }),
    (c.Route.prototype.back = function () {
      if (0 < this.step_count) {
        this.step_count--;
        var l = this.route.legs[0].steps[this.step_count].path;
        for (var e in l) l.hasOwnProperty(e) && this.polyline.pop();
      }
    }),
    (c.Route.prototype.forward = function () {
      if (this.step_count < this.steps_length) {
        var l = this.route.legs[0].steps[this.step_count].path;
        for (var e in l) l.hasOwnProperty(e) && this.polyline.push(l[e]);
        this.step_count++;
      }
    }),
    (c.prototype.checkGeofence = function (l, e, t) {
      return t.containsLatLng(new google.maps.LatLng(l, e));
    }),
    (c.prototype.checkMarkerGeofence = function (l, e) {
      if (l.fences)
        for (var t, a = 0; (t = l.fences[a]); a++) {
          var s = l.getPosition();
          this.checkGeofence(s.lat(), s.lng(), t) || e(l, t);
        }
    }),
    (c.prototype.toImage = function (l) {
      l = l || {};
      var e = {};
      if (
        ((e.size = l.size || [this.el.clientWidth, this.el.clientHeight]),
        ...
        for (var t = 0; t < this.markers.length; t++)
          e.markers.push({
            lat: this.markers[t].getPosition().lat(),
            lng: this.markers[t].getPosition().lng(),
          });
      }
      if (0 < this.polylines.length) {
        var a = this.polylines[0];
        (e.polyline = {}),
          (e.polyline.path = google.maps.geometry.encoding.encodePath(
            a.getPath()
          )),
          (e.polyline.strokeColor = a.strokeColor),
          (e.polyline.strokeOpacity = a.strokeOpacity),
          (e.polyline.strokeWeight = a.strokeWeight);
      }
      return c.staticMapURL(e);
    }),
    (c.staticMapURL = function (l) {
      var e,
        t = [],
        a =
          ('file:' === location.protocol ? 'http:' : location.protocol) +
          '//maps.googleapis.com/maps/api/staticmap';
      l.url && ((a = l.url), delete l.url), (a += '?');
      var s = l.markers;
      delete l.markers, !s && l.marker && ((s = [l.marker]), delete l.marker);
      var o = l.styles;
      delete l.styles;
      var n = l.polyline;
      if ((delete l.polyline, l.center))
        t.push('center=' + l.center), delete l.center;
      else if (l.address) t.push('center=' + l.address), delete l.address;
      else if (l.lat)
        t.push(['center=', l.lat, ',', l.lng].join('')),
          delete l.lat,
          delete l.lng;
      else if (l.visible) {
        var i = encodeURI(l.visible.join('|'));
        t.push('visible=' + i);
      }
      var r = l.size;
      r ? (r.join && (r = r.join('x')), delete l.size) : (r = '630x300'),
        t.push('size=' + r),
        l.zoom || !1 === l.zoom || (l.zoom = 15);
      var c = !l.hasOwnProperty('sensor') || !!l.sensor;
      for (var h in (delete l.sensor, t.push('sensor=' + c), l))
        l.hasOwnProperty(h) && t.push(h + '=' + l[h]);
      if (s)
        for (var p, m, u = 0; (e = s[u]); u++) {
          for (var h in ((p = []),
          e.size && 'normal' !== e.size
            ? (p.push('size:' + e.size), delete e.size)
            : e.icon && (p.push('icon:' + encodeURI(e.icon)), delete e.icon),
          e.color &&
            (p.push('color:' + e.color.replace('#', '0x')), delete e.color),
          e.label &&
            (p.push('label:' + e.label[0].toUpperCase()), delete e.label),
          (m = e.address ? e.address : e.lat + ',' + e.lng),
          delete e.address,
          delete e.lat,
          delete e.lng,
          e))
            e.hasOwnProperty(h) && p.push(h + ':' + e[h]);
          p.length || 0 === u
            ? (p.push(m), (p = p.join('|')), t.push('markers=' + encodeURI(p)))
            : ((p = t.pop() + encodeURI('|' + m)), t.push(p));
        }
      if (o)
        for (u = 0; u < o.length; u++) {
          var g = [];
          o[u].featureType &&
            g.push('feature:' + o[u].featureType.toLowerCase()),
            o[u].elementType &&
              g.push('element:' + o[u].elementType.toLowerCase());
          for (var L = 0; L < o[u].stylers.length; L++)
            for (var d in o[u].stylers[L]) {
              var v = o[u].stylers[L][d];
              ('hue' != d && 'color' != d) || (v = '0x' + v.substring(1)),
                g.push(d + ':' + v);
            }
          var z = g.join('|');
          '' != z && t.push('style=' + z);
      ...
      function f(l, e) {
        if ('#' === l[0] && ((l = l.replace('#', '0x')), e)) {
          if (((e = parseFloat(e)), 0 === (e = Math.min(1, Math.max(e, 0)))))
            return '0x00000000';
          1 === (e = (255 * e).toString(16)).length && (e += e),
            (l = l.slice(0, 8) + e);
        }
        return l;
      }
      if (n) {
        if (
          ((e = n),
          (n = []),
          e.strokeWeight && n.push('weight:' + parseInt(e.strokeWeight, 10)),
          e.strokeColor)
        ) {
          var y = f(e.strokeColor, e.strokeOpacity);
          n.push('color:' + y);
        }
        if (e.fillColor) {
          var M = f(e.fillColor, e.fillOpacity);
          n.push('fillcolor:' + M);
        }
        var b = e.path;
        if (b.join) {
          var w;
          for (L = 0; (w = b[L]); L++) n.push(w.join(','));
        } else n.push('enc:' + b);
        (n = n.join('|')), t.push('path=' + encodeURI(n));
      }
      var k = window.devicePixelRatio || 1;
      return t.push('scale=' + k), a + (t = t.join('&'));
    }),
    (c.prototype.addMapType = function (l, e) {
      if (!e.hasOwnProperty('getTileUrl') || 'function' != typeof e.getTileUrl)
        throw "'getTileUrl' function required.";
      e.tileSize = e.tileSize || new google.maps.Size(256, 256);
      var t = new google.maps.ImageMapType(e);
      this.map.mapTypes.set(l, t);
    }),
    (c.prototype.addOverlayMapType = function (l) {
      if (!l.hasOwnProperty('getTile') || 'function' != typeof l.getTile)
        throw "'getTile' function required.";
      var e = l.index;
      delete l.index, this.map.overlayMapTypes.insertAt(e, l);
    }),
    (c.prototype.removeOverlayMapType = function (l) {
      this.map.overlayMapTypes.removeAt(l);
    }),
    (c.prototype.addStyle = function (l) {
      var e = new google.maps.StyledMapType(l.styles, {
        name: l.styledMapName,
      });
      this.map.mapTypes.set(l.mapTypeId, e);
    }),
    (c.prototype.setStyle = function (l) {
      this.map.setMapTypeId(l);
    }),
    (c.prototype.createPanorama = function (l) {
      return (
        (l.hasOwnProperty('lat') && l.hasOwnProperty('lng')) ||
          ((l.lat = this.getCenter().lat()), (l.lng = this.getCenter().lng())),
        (this.panorama = c.createPanorama(l)),
        this.map.setStreetView(this.panorama),
        this.panorama
      );
    }),
    (c.createPanorama = function (t) {
      var l = j(t.el, t.context);
      ...
      for (
        ...
        delete a[e[s]];
      var o = new google.maps.StreetViewPanorama(l, a);
    ...
    (c.prototype.on = function (l, e) {
      return c.on(l, this, e);
    }),
    (c.prototype.off = function (l) {
      c.off(l, this);
    }),
    (c.prototype.once = function (l, e) {
      return c.once(l, this, e);
    }),
    (c.custom_events = [
      'marker_added',
      'marker_removed',
    ...
    (c.on = function (l, e, t) {
      if (-1 == c.custom_events.indexOf(l))
        return (
          e instanceof c && (e = e.map), google.maps.event.addListener(e, l, t)
        );
      var a = { handler: t, eventName: l };
      return (
        (e.registered_events[l] = e.registered_events[l] || []),
        e.registered_events[l].push(a),
        a
      );
    }),
    (c.off = function (l, e) {
      -1 == c.custom_events.indexOf(l)
        ? (e instanceof c && (e = e.map),
          google.maps.event.clearListeners(e, l))
        : (e.registered_events[l] = []);
    }),
    (c.once = function (l, e, t) {
      if (-1 == c.custom_events.indexOf(l))
        return (
          e instanceof c && (e = e.map),
          google.maps.event.addListenerOnce(e, l, t)
        );
    }),
    (c.fire = function (l, e, t) {
      if (-1 == c.custom_events.indexOf(l))
      ...
      else if (l in t.registered_events)
        for (var a = t.registered_events[l], s = 0; s < a.length; s++)
          (o = a[s].handler), (n = t), (i = e), o.apply(n, [i]);
      var o, n, i;
    }),
    ...
    (c.geocode = function (l) {
      this.geocoder = new google.maps.Geocoder();
      var t = l.callback;
      l.hasOwnProperty('lat') &&
        l.hasOwnProperty('lng') &&
        (l.latLng = new google.maps.LatLng(l.lat, l.lng)),
        delete l.lat,
        delete l.lng,
        delete l.callback,
        this.geocoder.geocode(l, function (l, e) {
          t(l, e);
        });
    }),
    'object' == typeof window.google &&
      ...
      (google.maps.Polygon.prototype.getBounds ||
        (google.maps.Polygon.prototype.getBounds = function (l) {
          for (
            var e,
      ...
      google.maps.Polygon.prototype.containsLatLng ||
        (google.maps.Polygon.prototype.containsLatLng = function (l) {
          ...
          if (null !== e && !e.contains(l)) return !1;
          for (var t = !1, a = this.getPaths().getLength(), s = 0; s < a; s++)
            for (
              var o = this.getPaths().getAt(s),
                n = o.getLength(),
                i = n - 1,
                r = 0;
              r < n;
              ...
              var c = o.getAt(r),
                h = o.getAt(i);
              ((c.lng() < l.lng() && h.lng() >= l.lng()) ||
                (h.lng() < l.lng() && c.lng() >= l.lng())) &&
                c.lat() +
                  ((l.lng() - c.lng()) / (h.lng() - c.lng())) *
                    (h.lat() - c.lat()) <
                  l.lat() &&
                (t = !t),
                (i = r);
      ...
      google.maps.Circle.prototype.containsLatLng ||
        (google.maps.Circle.prototype.containsLatLng = function (l) {
          return (
      ...
      (google.maps.Rectangle.prototype.containsLatLng = function (l) {
        return this.getBounds().contains(l);
      }),
      (google.maps.LatLngBounds.prototype.containsLatLng = function (l) {
        return this.contains(l);
      }),
      (google.maps.Marker.prototype.setFences = function (l) {
        this.fences = l;
      }),
      (google.maps.Marker.prototype.addFence = function (l) {
        this.fences.push(l);
      }),
    ...
    Array.prototype.indexOf ||
      (Array.prototype.indexOf = function (l) {
        ...
        if (
          ...
          return -1;
        for (var s = 0 <= a ? a : Math.max(t - Math.abs(a), 0); s < t; s++)
          if (s in e && e[s] === l) return s;
        return -1;
      }),
    c
  );
});
var VectorCanvas = function (l, e, t) {
  if (
...
var ColorScale = function (l, e, t, a) {
  l && this.setColors(l),
...
var JQVMap = function (o) {
  ...
  (this.multiSelectRegion = o.multiSelectRegion),
  (this.container = o.container),
  (this.defaultWidth = i.width),
  (this.defaultHeight = i.height),
  (this.color = o.color),
  (this.selectedColor = o.selectedColor),
  (this.hoverColor = o.hoverColor),
  (this.hoverColors = o.hoverColors),
  (this.hoverOpacity = o.hoverOpacity),
  this.setBackgroundColor(o.backgroundColor),
  (this.width = o.container.width()),
  (this.height = o.container.height()),
  this.resize(),
  jQuery(window).resize(function () {
    var l = o.container.width(),
      e = o.container.height();
    if (l && e) {
      (n.width = l),
        (n.height = e),
        n.resize(),
        ...
        n.applyTransform();
      var t = jQuery.Event('resize.jqvmap');
      jQuery(o.container).trigger(t, [l, e]),
        a &&
          (jQuery('.jqvmap-pin').remove(),
          (n.pinHandlers = !1),
          n.placePins(a.pins, a.mode));
    }
  }),
  (this.canvas = new VectorCanvas(this.width, this.height, o)),
  o.container.append(this.canvas.canvas),
  this.makeDraggable(),
  ...
  (this.label = jQuery('<div/>')
    ...
    .hide()),
  o.enableZoom &&
    (jQuery('<div/>').addClass('jqvmap-zoomin').text('+').appendTo(o.container),
    jQuery('<div/>')
  ...
  (n.countries = []),
  i.paths)) {
    var e = this.canvas.createPath({ path: i.paths[l].path });
    e.setFill(this.color),
      (e.id = n.getCountryId(l)),
      (n.countries[l] = e),
      'svg' === this.canvas.mode
        ? e.setAttribute('class', 'jqvmap-region')
        : jQuery(e).addClass('jqvmap-region'),
      jQuery(this.rootGroup).append(e);
  }
  if (
    (jQuery(o.container).delegate(
      'svg' === this.canvas.mode ? 'path' : 'shape',
      'mouseover mouseout',
      function (l) {
        var e = l.target,
          t = l.target.id.split('_').pop(),
          a = jQuery.Event('labelShow.jqvmap'),
          s = jQuery.Event('regionMouseOver.jqvmap');
        (t = t.toLowerCase()),
          'mouseover' === l.type
            ? (jQuery(o.container).trigger(s, [t, i.paths[t].name]),
              s.isDefaultPrevented() || n.highlight(t, e),
              o.showTooltip &&
                (n.label.text(i.paths[t].name),
                jQuery(o.container).trigger(a, [n.label, t]),
            ...
            : (n.unhighlight(t, e),
              n.label.hide(),
              jQuery(o.container).trigger('regionMouseOut.jqvmap', [
                t,
                i.paths[t].name,
              ]));
      }
    ...
    jQuery(o.container).delegate(
      ...
      function (l) {
        ...
        if (
          ((t = t.toLowerCase()),
          jQuery(o.container).trigger(a, [t, i.paths[t].name]),
          !o.multiSelectRegion && !a.isDefaultPrevented())
        )
          for (var s in i.paths)
            (n.countries[s].currentFillColor = n.countries[
              s
            ].getOriginalFill()),
              n.countries[s].setFill(n.countries[s].getOriginalFill());
        a.isDefaultPrevented() ||
          (n.isSelected(t) ? n.deselect(t, e) : n.select(t, e));
      }
    ),
    o.showTooltip &&
      o.container.mousemove(function (l) {
        if (n.label.is(':visible')) {
          var e = l.pageX - 15 - n.labelWidth,
            t = l.pageY - 15 - n.labelHeight;
          e < 0 && (e = l.pageX + 15),
            t < 0 && (t = l.pageY + 15),
            n.label.css({ left: e, top: t });
        }
      }),
    this.setColors(o.colors),
    ...
    o.values && ((this.values = o.values), this.setValues(o.values)),
    o.selectedRegions)
  )
    if (o.selectedRegions instanceof Array)
      for (var t in o.selectedRegions)
        this.select(o.selectedRegions[t].toLowerCase());
    else this.select(o.selectedRegions.toLowerCase());
  if (
    (this.bindZoomButtons(),
    o.pins &&
      ((a = { pins: o.pins, mode: o.pinMode }),
      (this.pinHandlers = !1),
      this.placePins(o.pins, o.pinMode)),
    o.showLabels)
  ) {
    this.pinHandlers = !1;
    var s = {};
    for (l in n.countries)
      'function' != typeof n.countries[l] &&
        ((o.pins && o.pins[l]) || (s[l] = l.toUpperCase()));
    (a = { pins: s, mode: 'content' }), this.placePins(s, 'content');
  }
  JQVMap.mapIndex++;
};
(JQVMap.prototype = {
  ...
  (function () {
    ...
    jQuery.fn.vectorMap = function (l) {
      var e = {
        ...
        t = this.data('mapObject');
      if ('addMap' === l) JQVMap.maps[arguments[1]] = arguments[2];
      else {
        if ('set' !== l || !o[arguments[1]]) {
          if ('string' == typeof l && 'function' == typeof t[l])
            return t[l].apply(t, Array.prototype.slice.call(arguments, 1));
          for (var a in (jQuery.extend(e, l),
          (e.container = this).css({
            position: 'relative',
            overflow: 'hidden',
          }),
          (t = new JQVMap(e)),
          this.data('mapObject', t),
          this.unbind('.jqvmap'),
          n))
            e[a] && this.bind(n[a] + '.jqvmap', e[a]);
          var s = jQuery.Event('load.jqvmap');
          return jQuery(e.container).trigger(s, t), t;
        }
        t[
  ...
  (ColorScale.arrayToRgb = function (l) {
    for (var e, t = '#', a = 0; a < l.length; a++)
      t += 1 === (e = l[a].toString(16)).length ? '0' + e : e;
    return t;
  }),
  (ColorScale.prototype.getColor = function (l) {
    'function' == typeof this.normalize && (l = this.normalize(l));
    for (var e, t = [], a = 0, s = 0; s < this.colors.length - 1; s++)
      (e = this.vectorLength(
        ...
        (a += e);
    var o,
      n = (this.maxValue - this.minValue) / a;
    for (s = 0; s < t.length; s++) t[s] *= n;
    for (s = 0, l -= this.minValue; 0 <= l - t[s]; ) (l -= t[s]), s++;
    for (
      o =
  ...
  (ColorScale.prototype.vectorAdd = function (l, e) {
    for (var t = [], a = 0; a < l.length; a++) t[a] = l[a] + e[a];
    return t;
  }),
  (ColorScale.prototype.vectorLength = function (l) {
    for (var e = 0, t = 0; t < l.length; t++) e += l[t] * l[t];
    return Math.sqrt(e);
  }),
  (ColorScale.prototype.vectorMult = function (l, e) {
    for (var t = [], a = 0; a < l.length; a++) t[a] = l[a] * e;
    return t;
  }),
  (ColorScale.prototype.vectorSubtract = function (l, e) {
    for (var t = [], a = 0; a < l.length; a++) t[a] = l[a] - e[a];
    return t;
  }),
  ...
  (JQVMap.prototype.deselect = function (l, e) {
    if (
      ((l = l.toLowerCase()),
      (e = e || jQuery('#' + this.getCountryId(l))[0]),
      this.isSelected(l))
    )
      ...
      for (var t in this.countries)
        this.selectedRegions.splice(this.selectedRegions.indexOf(t), 1),
          (this.countries[t].currentFillColor = this.color),
          this.countries[t].setFill(this.color);
  }),
  ...
  (JQVMap.prototype.getPins = function () {
    var l = this.container.find('.jqvmap-pin'),
      s = {};
    return (
      jQuery.each(l, function (l, e) {
        var t = (e = jQuery(e)).attr('for').toLowerCase(),
          a = e.html();
        s[t] = a;
      }),
      JSON.stringify(s)
  ...
  (JQVMap.prototype.highlight = function (l, e) {
    (e = e || jQuery('#' + this.getCountryId(l))[0]),
      this.hoverOpacity
        ? e.setOpacity(this.hoverOpacity)
        : this.hoverColors && l in this.hoverColors
        ? ((e.currentFillColor = e.getFill() + ''),
          e.setFill(this.hoverColors[l]))
        : this.hoverColor &&
    ...
    (u.isMoving = !1),
      ...
      this.container
        .mousemove(function (l) {
          return (
            a &&
              ((u.transX -= (e - l.pageX) / u.scale),
              (u.transY -= (t - l.pageY) / u.scale),
              u.applyTransform(),
              (e = l.pageX),
              (t = l.pageY),
              (u.isMoving = !0),
      ...
      jQuery(this.container).bind('touchmove', function (l) {
        var e,
          ...
          a,
          s,
          o = l.originalEvent.touches;
        if (1 === o.length) {
          if (1 === n) {
            if (p === o[0].pageX && m === o[0].pageY) return;
            (a = u.transX),
              (s = u.transY),
              (u.transX -= (p - o[0].pageX) / u.scale),
              (u.transY -= (m - o[0].pageY) / u.scale),
              u.applyTransform(),
              (a === u.transX && s === u.transY) || l.preventDefault(),
              (u.isMoving = !0),
              u.isMovingTimeout && clearTimeout(u.isMovingTimeout);
          }
          (p = o[0].pageX), (m = o[0].pageY);
        } else 2 === o.length && (2 === n ? ((t = Math.sqrt(Math.pow(o[0].pageX - o[1].pageX, 2) + Math.pow(o[0].pageY - o[1].pageY, 2)) / c), u.setScale(h * t, i, r), l.preventDefault()) : ((e = jQuery(u.container).offset()), (i = o[0].pageX > o[1].pageX ? o[1].pageX + (o[0].pageX - o[1].pageX) / 2 : o[0].pageX + (o[1].pageX - o[0].pageX) / 2), (r = o[0].pageY > o[1].pageY ? o[1].pageY + (o[0].pageY - o[1].pageY) / 2 : o[0].pageY + (o[1].pageY - o[0].pageY) / 2), (i -= e.left), (r -= e.top), (h = u.scale), (c = Math.sqrt(Math.pow(o[0].pageX - o[1].pageX, 2) + Math.pow(o[0].pageY - o[1].pageY, 2)))));
        n = o.length;
      }),
  ...
  (JQVMap.prototype.placePins = function (l, e) {
    var s = this;
    if (
      ((e && ('content' === e || 'id' === e)) || (e = 'content'),
      'content' === e
        ? jQuery.each(l, function (l, e) {
            if (0 !== jQuery('#' + s.getCountryId(l)).length) {
              var t = s.getPinId(l),
                a = jQuery('#' + t);
              0 < a.length && a.remove(),
                s.container.append(
      ...
      this.container.bind('zoomIn', t).bind('zoomOut', t).bind('drag', t);
    }
  }),
  (JQVMap.prototype.positionPins = function () {
    ...
    jQuery.each(l, function (l, e) {
      e = jQuery(e);
      var t = c.getCountryId(e.attr('for').toLowerCase()),
        a = jQuery('#' + t),
        s = document.getElementById(t).getBBox(),
        o = a.position(),
        n = c.scale,
        i = o.left + (s.width / 2) * n - e.width() / 2,
        r = o.top + (s.height / 2) * n - e.height() / 2;
      e.css('left', i).css('top', r);
    });
  }),
  ...
  (JQVMap.prototype.select = function (l, e) {
    (l = l.toLowerCase()),
      (e = e || jQuery('#' + this.getCountryId(l))[0]),
      this.isSelected(l) ||
        (this.multiSelectRegion
          ? this.selectedRegions.push(l)
          : (this.selectedRegions = [l]),
  ...
  (JQVMap.prototype.selectIndex = function (l) {
    ...
    for (var e = 0; e < this.selectedRegions.length; e++)
      if (l === this.selectedRegions[e]) return e;
    return -1;
  }),
  (JQVMap.prototype.setBackgroundColor = function (l) {
    this.container.css('background-color', l);
  }),
  (JQVMap.prototype.setColors = function (l, e) {
    if ('string' == typeof l)
      this.countries[l].setFill(e),
        this.countries[l].setAttribute('original', e);
    else {
      var t = l;
      for (var a in t)
        this.countries[a] &&
          (this.countries[a].setFill(t[a]),
          this.countries[a].setAttribute('original', t[a]));
    }
  }),
  ...
  (JQVMap.prototype.setValues = function (l) {
    ...
    for (var s in l)
      (s = s.toLowerCase()),
        (e = parseFloat(l[s])),
        isNaN(e) || (t < e && (t = l[s]), e < a && (a = e));
    a === t && t++, this.colorScale.setMin(a), this.colorScale.setMax(t);
    var o = {};
    for (s in l)
      (s = s.toLowerCase()),
        (e = parseFloat(l[s])),
        (o[s] = isNaN(e) ? this.color : this.colorScale.getColor(e));
    this.setColors(o), (this.values = l);
  }),
  (JQVMap.prototype.unhighlight = function (l, e) {
    (l = l.toLowerCase()),
      (e = e || jQuery('#' + this.getCountryId(l))[0]).setOpacity(1),
  ...
  (JQVMap.prototype.zoomIn = function () {
    ...
    if (l.zoomCurStep < l.zoomMaxStep) {
      (l.transX -= (l.width / l.scale - l.width / (l.scale * l.zoomStep)) / 2),
        (l.transY -=
          (l.height / l.scale - l.height / (l.scale * l.zoomStep)) / 2),
        l.setScale(l.scale * l.zoomStep),
        l.zoomCurStep++;
      var t = jQuery('#zoomSlider');
      t.css('top', parseInt(t.css('top'), 10) - e),
  ...
  (JQVMap.prototype.zoomOut = function () {
    ...
    if (1 < l.zoomCurStep) {
      (l.transX += (l.width / (l.scale / l.zoomStep) - l.width / l.scale) / 2),
        (l.transY +=
          (l.height / (l.scale / l.zoomStep) - l.height / l.scale) / 2),
        l.setScale(l.scale / l.zoomStep),
        l.zoomCurStep--;
      var t = jQuery('#zoomSlider');
      t.css('top', parseInt(t.css('top'), 10) + e),
  ...
  (VectorCanvas.prototype.applyTransformParams = function (l, e, t) {
    'svg' === this.mode
  ...
  (VectorCanvas.prototype.createGroup = function (l) {
    ...
    return (
      'svg' === this.mode
        ...
        : (((e = this.createVmlNode('group')).style.width = this.width + 'px'),
  ...
  (VectorCanvas.prototype.createPath = function (l) {
    ...
    if ('svg' === this.mode)
      (e = this.createSvgNode('path')).setAttribute('d', l.path),
        ...
        (e.setOpacity = function (l) {
          this.setAttribute('fill-opacity', l);
        });
    else {
      ((e = this.createVmlNode('shape')).coordorigin = '0 0'),
        (e.coordsize = this.width + ' ' + this.height),
        (e.style.width = this.width + 'px'),
        (e.style.height = this.height + 'px'),
        (e.fillcolor = JQVMap.defaultFillColor),
        (e.stroked = !1),
        (e.path = VectorCanvas.pathSvgToVml(l.path));
      var t = this.createVmlNode('skew');
      (t.on = !0),
        (t.matrix = '0.01,0,0,0.01,0,0'),
        (t.offset = '0,0'),
        e.appendChild(t);
      ...
      .replace(
        ...
        function (l, e, t) {
          ...
          for (var a = 0, s = t.length; a < s; a++)
            t[a] = Math.round(100 * t[a]);
          switch (e) {
            case 'm':
              (r += t[0]), (c += t[1]), (i = 't' + t.join(','));
              break;
            case 'M':
              (r = t[0]), (c = t[1]), (i = 'm' + t.join(','));
              break;
            case 'l':
              (r += t[0]), (c += t[1]), (i = 'r' + t.join(','));
              break;
            case 'L':
              (r = t[0]), (c = t[1]), (i = 'l' + t.join(','));
              break;
            case 'h':
              (r += t[0]), (i = 'r' + t[0] + ',0');
              break;
  ...
  (VectorCanvas.prototype.setSize = function (l, e) {
    if ('svg' === this.mode)
      ...
      (this.canvas.coordsize = l + ' ' + e),
      (this.canvas.coordorigin = '0 0'),
      this.rootGroup)
    ) {
      for (
        var t = this.rootGroup.getElementsByTagName('shape'),
          a = 0,
          s = t.length;
        a < s;
        a++
  ...
  jQuery.fn.vectorMap('addMap', 'world_en', {
    ...
    paths: {
      ...
      gw: {
        path:
          'M408.6,304.53l1.4,2.77l3.93-3.38l0.04-1.04l-4.63-0.67L408.6,304.53L408.6,304.53z',
        name: 'Guinea-Bissau',
      },
      gn: {
        path:
      ...
      sl: {
        path:
          'M413.93,313.13l5.65,5.46l4.03-4.89l-2.52-3.95l-3.47,0.35L413.93,313.13L413.93,313.13z',
        name: 'Sierra Leone',
      },
      lr: {
        path:
          'M420.17,319.19l10.98,7.34l-0.26-5.56l-3.32-3.91l-3.24-2.87L420.17,319.19L420.17,319.19z',
        name: 'Liberia',
      },
      ci: {
        path:
      ...
      tg: {
        path:
          'M455.22,321.25l2.68-1.57l-0.06-10.35l-1.74-2.82l-1.12,0.94L455.22,321.25L455.22,321.25z',
        name: 'Togo',
      },
      bj: {
        path:
      ...
      dj: {
        path:
          'M571.48,301.54l-0.57,3.36l3.96-0.06l0.06-4.94l-1.45-0.89L571.48,301.54L571.48,301.54z',
        name: 'Djibouti',
      },
      et: {
        path:
      ...
      rw: {
        path:
          'M537.82,339.9l2.81,2.59l-0.12,2.77l-4.36,0.09v-3.06L537.82,339.9L537.82,339.9z',
        name: 'Rwanda',
      },
      bi: {
        path:
          'M536.21,346.21l4.27-0.09l-1.11,3.74l-1.08,0.94h-1.32l-0.94-2.53L536.21,346.21L536.21,346.21z',
        name: 'Burundi',
      },
      ug: {
        path:
      ...
      sz: {
        path:
          'M540.87,414l-2.51,0.42l-1.08,2.95l1.92,1.75h2.33l1.97-2.83L540.87,414L540.87,414z',
        name: 'Swaziland',
      },
      ls: {
        path:
      ...
      nc: {
        path:
          'M906.64,420.47l-0.35,1.79l4.61,6.43l2.48,1.07l0.35-2.5L906.64,420.47L906.64,420.47z',
        name: 'New Caledonia',
      },
      my: {
        path:
      ...
      bn: {
        path:
          'M779.77,319.25l-2.88,3.49l2.36,0.74l1.33-1.86L779.77,319.25L779.77,319.25z',
      ...
      fj: {
        path:
          'M948.62,412.29l-1.24,1.66l-0.1,1.87l1.44,1.46L948.62,412.29L948.62,412.29z',
        name: 'Fiji',
      },
      ph: {
        path:
      ...
      tw: {
        path:
          'M787.46,248.31l-3.54,2.7l-0.19,5.2l3.06,3.56l0.76-0.67L787.46,248.31L787.46,248.31z',
        name: 'Taiwan',
      },
      jp: {
        path:
      ...
      mu: {
        path:
          'M613.01,398.99l-1.52,1.99l0.3,2.15l3.2-2.61L613.01,398.99L613.01,398.99z',
        name: 'Mauritius',
      },
      re: {
        path:
          'M607.38,402.37l-2.28,0.15l-0.15,1.99l1.52,0.31l2.28-1.07L607.38,402.37L607.38,402.37z',
        name: 'Reunion',
      },
      mg: {
        path:
      ...
      kn: {
        path:
          'M276.6,283.37l-1.5,0.62l0.53,1.33l1.76-1.15l-0.35-0.36L276.6,283.37L276.6,283.37z',
        name: 'Saint Kitts and Nevis',
      },
      ag: {
        path:
          'M279.07,284.88l-0.88,1.87l1.06,1.42l1.32-1.15L279.07,284.88L279.07,284.88z',
        name: 'Antigua and Barbuda',
      },
      dm: {
        path:
          'M282.07,290.03l-1.06,0.98l0.79,1.6l1.5-0.44L282.07,290.03L282.07,290.03z',
        name: 'Dominica',
      },
      lc: {
        path:
          'M281.98,294.03l-0.71,1.51l1.15,1.24l1.5-0.8L281.98,294.03L281.98,294.03z',
        name: 'Saint Lucia',
      },
      bb: {
        path:
          'M282.07,297.85l-1.23,0.89l0.97,1.78l1.59-0.89L282.07,297.85L282.07,297.85z',
        name: 'Barbados',
      },
      gd: {
        path:
          'M280.57,301.31l-1.15,1.15l0.44,0.71h1.41l0.44-1.16L280.57,301.31L280.57,301.31z',
        name: 'Grenada',
      },
      tt: {
        path:
      ...
      jm: {
        path:
          'M238.93,279.59l-3.48,0.88v0.97l2.03,1.17h2.13l1.35-1.56L238.93,279.59L238.93,279.59z',
        name: 'Jamaica',
      },
      ec: {
        path:
      ...
      sv: {
        path:
          'M201.65,296.27l4.7,2.34l-0.07-3.71l-2.41-1.47L201.65,296.27L201.65,296.27z',
        name: 'El Salvador',
      },
      ni: {
        path:
      ...
      gf: {
        path:
          'M302.13,321.8l5.85,3.65l-3.06,6.08l-1.11,1.4l-3.25-1.87l0.09-6.55L302.13,321.8L302.13,321.8z',
        name: 'French Guiana',
      },
      pe: {
        path:
      ...
      uy: {
        path:
          'M300.36,431.93l-2.05,2.19l0.85,11.78l6.44,1.87l8.19-8.21L300.36,431.93L300.36,431.93z',
        name: 'Uruguay',
      },
      ar: {
        path:
      ...
      bz: {
        path:
          'M204.56,282.4l-0.05,3.65h0.84l2.86-5.34h-1.94L204.56,282.4L204.56,282.4z',
        name: 'Belize',
      },
      mn: {
        path:
      ...
      kw: {
        path:
          'M583.29,247.17l-2.25-1.22l-1.56,1.57l0.17,3.14l3.63,1.39L583.29,247.17L583.29,247.17z',
        name: 'Kuwait',
      },
      sa: {
        path:
      ...
      lb: {
        path:
          'M546.2,232.44l0.06,1.95l-0.82,2.96l2.82,0.24l0.18-4.2L546.2,232.44L546.2,232.44z',
        name: 'Lebanon',
      },
      il: {
        path:
          'M545.32,238.06l-1.58,5.03l2.05,6.03l2.35-8.81v-1.89L545.32,238.06L545.32,238.06z',
        name: 'Israel',
      },
      cy: {
        path:
      ...
      si: {
        path:
          'M494.8,191.99l-2.54,1.52l-4.74,1.04l0.95,2.74l3.32,0.04l3.06-2.56L494.8,191.99L494.8,191.99z',
        name: 'Slovenia',
      },
      hr: {
        path:
      ...
      ba: {
        path:
          'M494.8,198.94l-0.37,0.61l6.71,6.92l2.46-3.62l-0.09-1.43l-2.15-2.61L494.8,198.94L494.8,198.94z',
        name: 'Bosnia and Herzegovina',
      },
      mt: {
        path:
          'M492.61,230.47l-1.67,0.34l0.06,1.85l1.5,0.5l0.67-0.56L492.61,230.47L492.61,230.47z',
        name: 'Malta',
      },
      ua: {
        path:
  ...
  jQuery.fn.vectorMap('addMap', 'usa_en', {
    ...
    paths: {
      ...
      de: {
        path:
          'm824.88,225.34c-3.72,0.25 -3.47,3.52 -1.91,6.13 3.35,6.89 3.86,14.58 6.03,21.81 3.45,0.11 6.81,-0.49 10.16,-1.25 -1.2,-2.17 -0.68,-6.38 -3.32,-6.38 -2.9,-1.2 -4.17,-3.69 -4.9,-6.58 -0.91,-3.11 -3.62,-4.96 -5.48,-7.35 -1.85,-1.82 0.94,-5.5 -0.26,-6.47l-0.33,0.09z',
        name: 'Delaware',
      },
      md: {
        path:
      ...
      sd: {
        path:
          'm357.44,187.41c25.68,1.58 51.37,3.15 77.06,4.26 3.58,-0.01 7.34,-0.51 10.81,-0.23 1.8,2.9 5.24,3.85 7.69,6 3.55,-1.45 7.52,-1.89 11.25,-1.91 2.45,2.67 7.26,2.29 9.15,5.33 1.32,4.76 3.27,1.86 0.18,-1.15 -1.53,-2.17 1.46,-4.6 1.56,-6.99 1.2,-2.87 1.38,-5.28 -1.58,-6.75 -0.5,-2.04 -0.73,-6.65 2.41,-5.84 2.62,-0.28 0.39,-5.28 1.06,-7.5 -0.32,-9.7 0.19,-19.47 -0.64,-29.13 -0.24,-3.58 -6.26,-4.19 -5.42,-8.4 1.09,-1.22 5.81,-4.38 2.75,-5.4 -27.23,-0.89 -54.5,-1.01 -81.67,-3.15 -9.79,-0.62 -19.57,-1.24 -29.36,-1.86 -1.75,20.91 -3.5,41.81 -5.25,62.72z',
        name: 'South Dakota',
      },
      nd: {
        path:
          'm362.88,123.72c26.46,1.49 52.89,3.7 79.4,3.91 10.84,0.26 21.67,0.52 32.51,0.78 0.01,-5.53 -1.38,-10.82 -2.5,-16.17 -1.27,-7.42 -2.05,-14.89 -2.13,-22.42 -2.61,-4.16 -4.11,-9 -3.48,-13.94 -0.44,-3.25 0.67,-6.57 0.3,-9.7 -0.15,-4.01 -2.83,-4.61 -6.31,-4.12 -25.15,-0.47 -50.33,-1.05 -75.41,-3.06 -5.17,-0.49 -10.33,-0.98 -15.5,-1.47 -2.29,22.06 -4.58,44.13 -6.88,66.19z',
        name: 'North Dakota',
      },
      wy: {
        path:
          'm240.16,217.84c37.4,4.49 74.29,8.23 111.69,12.72 2.5,-29.2 5.5,-57.65 8,-86.84 -35.26,-4.45 -70.52,-8.9 -105.78,-13.34 -4.64,29.16 -9.27,58.31 -13.91,87.47z',
        name: 'Wyoming',
      },
      mt: {
        path:
      ...
      co: {
        path:
          'm260.17,308.53c39.89,4.09 79.51,8.26 119.39,11.91 1.61,-28.46 3.23,-56.92 4.84,-85.38 -37.47,-4.17 -74.94,-8.33 -112.41,-12.5 -4.03,28.98 -7.8,56.99 -11.83,85.97z',
        name: 'Colorado',
      },
      id: {
        path:
          'm169.84,91.72c0.52,3.07 2.27,5.25 4.94,6.78 0.4,3.02 -0.61,5.46 -3.03,7.31 -2.3,2.7 -4.38,5.97 -6.09,8.83 0.39,2.93 -2.57,3.54 -4.23,4.8 -1.77,2.31 -4.28,4.3 -3.93,7.5 -0.64,2.43 4.69,0.57 4.09,4.34 -5.19,11.17 -6.78,23.51 -10.13,35.32 -0.79,3.16 -1.22,4.91 -2.01,8.08 56.92,12.84 62.26,13.45 93.58,19.41 2.75,-17.6 5.5,-35.21 8.25,-52.81 -2.66,-0.84 -0.58,-6.52 -4.23,-4.97 -1.24,1.7 -1.62,4.95 -5.17,3.47 -3.11,-1.99 -6.81,-1.34 -10.13,-0.56 -2.53,-1.76 -5.91,-2.01 -7.69,0.88 -1.75,-0.05 -3.29,-3.39 -2.79,-5.36 1.91,-3.98 -2.85,-5.89 -5